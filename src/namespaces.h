...
/**
 * This is the main namespace of AutoPas. Everything defined within AutoPas directory should be in this namespace.
 */
namespace autopas {
 ...
 * These classes reside mostly in the utils directory. However, most commonly used function inside the utils directory
