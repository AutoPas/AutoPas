...
class LJFunctorCuda : public Functor<Particle, ParticleCell, typename Particle::SoAArraysType> {
 ...
 public:
  ...
  void AoSFunctorNoN3(int N, double* particles){
	  AoSFunctorNoN3Wrapper(N, particles);
  }
  ...
  void deviceSoALoader(::autopas::SoA<SoAArraysType> &soa, typename Particle::SoADevice &device_handle) {
      ...
      cudaError_t e;
      e = cudaMemcpy(device_handle.posX, soa.template begin<Particle::AttributeNames::posX>(), size, cudaMemcpyHostToDevice);
      e = cudaMemcpy(device_handle.posY, soa.template begin<Particle::AttributeNames::posY>(), size, cudaMemcpyHostToDevice);
      e = cudaMemcpy(device_handle.posZ, soa.template begin<Particle::AttributeNames::posZ>(), size, cudaMemcpyHostToDevice);
      e = cudaMemcpy(device_handle.forceX, soa.template begin<Particle::AttributeNames::forceX>(), size, cudaMemcpyHostToDevice);
      e = cudaMemcpy(device_handle.forceY, soa.template begin<Particle::AttributeNames::forceY>(), size, cudaMemcpyHostToDevice);
      e = cudaMemcpy(device_handle.forceZ, soa.template begin<Particle::AttributeNames::forceZ>(), size, cudaMemcpyHostToDevice);
  }
  ...
  void deviceSoAExtractor(::autopas::SoA<SoAArraysType> &soa, typename Particle::SoADevice &device_handle){
	  ...
	  cudaMemcpy(soa.template begin<Particle::AttributeNames::forceX>(), device_handle.forceX, size, cudaMemcpyDeviceToHost);
	  cudaMemcpy(soa.template begin<Particle::AttributeNames::forceY>(), device_handle.forceY, size, cudaMemcpyDeviceToHost);
	  cudaMemcpy(soa.template begin<Particle::AttributeNames::forceZ>(), device_handle.forceZ, size, cudaMemcpyDeviceToHost);
