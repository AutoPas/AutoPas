...
class LJFunctorAVX : public Functor<Particle, ParticleCell, typename Particle::SoAArraysType> {
 ...
 private:
  ...
  inline void SoAKernel(size_t j, const __m256d &x1, const __m256d &y1, const __m256d &z1,
    ...
    const __m256d facMasked = masked
                                  ...
                                  ? _mm256_and_pd(fac, _mm256_and_pd(cutoffMask, (__m256d)(_masks[rest - 1])))
    ...
    if (calculateGlobals) {
      ...
      const __m256d upot =
          masked ? _mm256_and_pd(upotPART2, _mm256_and_pd(cutoffMask, (__m256d)(_masks[rest - 1])))
 ...
 private:
  template <bool stage>
  inline __m256d permute(__m256d in) {
    if (stage) {
 ...
 private:
  ...
  inline void SoAPermKernel(__m256d const x1, __m256d const y1, __m256d const z1, __m256d &fx1, __m256d &fy1, __m256d &fz1, int r1, 
    ...
    //TODO only if newton 3 - else all 0s
    ...
    for (unsigned int a = 0; a < 4; a++) {
      ...
      if (masked1 and masked2) {
        mask1and2 = _mm256_and_pd((__m256d)(mask1), (__m256d)(mask2));
      } else if (masked1) {
        mask1and2 = (__m256d)(mask1);
      } else if (masked2) {
        mask1and2 = (__m256d)(mask2);
      }
      ...
      mask2 = _mm256_castpd_si256(permute<true>((__m256d)(mask2)));
      } else {
      x2 = permute<false>(x2);
      y2 = permute<false>(y2);
      z2 = permute<false>(z2);
      ...
      mask2 = _mm256_castpd_si256(permute<false>((__m256d)(mask2)));
      }
    }
