...
#include "autopas/containers/directSum/traversals/DSSequentialTraversalMidpoint.h"
...
std::unique_ptr<TraversalInterface> TraversalSelector<ParticleCell>::generatePairwiseTraversal(
  ...
  switch (traversalType) {
    ...
    case TraversalOption::ds_sequential_midpoint: {
      return std::make_unique<DSSequentialTraversalMidpoint<ParticleCell, PairwiseFunctor>>(
          &pairwiseFunctor,
          traversalInfo
              .interactionLength /*this is the cutoff, as generated by DirectSum::getTraversalSelectorInfo()!*/,
...
std::unique_ptr<TraversalInterface> TraversalSelector<ParticleCell>::generateTriwiseTraversal(
  ...
  switch (traversalType) {
    ...
    case TraversalOption::ds_sequential_midpoint: {
      return std::make_unique<DSSequentialTraversalMidpoint<ParticleCell, TriwiseFunctor>>(
          &triwiseFunctor,
          traversalInfo
              .interactionLength /*this is the cutoff, as generated by DirectSum::getTraversalSelectorInfo()!*/,
          dataLayout, useNewton3, traversalInfo.boxMin, traversalInfo.boxMax);
