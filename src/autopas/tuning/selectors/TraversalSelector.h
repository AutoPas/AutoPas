...
#include "autopas/containers/verletClusterLists/traversals/VCLClusterIterationTraversal3B.h"
#include "autopas/containers/verletClusterLists/traversals/VCLListIntersectionTraversal3B.h"
#include "autopas/containers/verletClusterLists/traversals/VCLPairListIterationTraversal3B.h"
...
std::unique_ptr<TraversalInterface> TraversalSelector<ParticleCell>::generateTriwiseTraversal(
  ...
  switch (traversalType) {
    ...
    // VerletLists
    case TraversalOption::vl_list_iteration: {
      return std::make_unique<VLListIterationTraversal<ParticleCell, TriwiseFunctor>>(&triwiseFunctor, dataLayout,
                                                                                      useNewton3);
    }
    ...
    case TraversalOption::vl_pair_list_iteration_3b: {
      ...
      // VerletClusterLists
    case TraversalOption::vcl_cluster_iteration_3b: {
      return std::make_unique<VCLClusterIterationTraversal3B<ParticleCell, TriwiseFunctor>>(&triwiseFunctor,
    ...
    case TraversalOption::vcl_pair_list_iteration_3b: {
      return std::make_unique<VCLPairListIterationTraversal3B<ParticleCell, TriwiseFunctor>>(&triwiseFunctor,
                                                                                            traversalInfo.clusterSize,
                                                                                            dataLayout, useNewton3);
    }
