...
class TraversalSelector {
 public:
   ...
   * @return Smartpointer to the traversal.
   */
  template <class PairwiseFunctor_T>
   ...
   * @return Smartpointer to the traversal.
   */
  template <class TriwiseFunctor_T>
...
template <class ParticleCell_T>
template <class PairwiseFunctor_T>
std::unique_ptr<TraversalInterface> TraversalSelector<ParticleCell_T>::generatePairwiseTraversal(
  ...
  switch (traversalType) {
    ...
    case TraversalOption::ds_sequential: {
      return std::make_unique<DSSequentialTraversal<ParticleCell_T, PairwiseFunctor_T>>(
          &pairwiseFunctor,
          traversalInfo
    ...
    case TraversalOption::lc_sliced: {
      return std::make_unique<LCSlicedTraversal<ParticleCell_T, PairwiseFunctor_T>>(
    ...
    case TraversalOption::lc_sliced_c02: {
      return std::make_unique<LCSlicedC02Traversal<ParticleCell_T, PairwiseFunctor_T>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3);
    }
    case TraversalOption::lc_sliced_balanced: {
      return std::make_unique<LCSlicedBalancedTraversal<ParticleCell_T, PairwiseFunctor_T>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3);
    }
    case TraversalOption::lc_c01: {
      return std::make_unique<LCC01Traversal<ParticleCell_T, PairwiseFunctor_T, false>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3);
    }
    case TraversalOption::lc_c01_combined_SoA: {
      return std::make_unique<LCC01Traversal<ParticleCell_T, PairwiseFunctor_T, true>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3);
    }
    case TraversalOption::lc_c04_combined_SoA: {
      return std::make_unique<LCC04CombinedSoATraversal<ParticleCell_T, PairwiseFunctor_T>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3);
    }
    case TraversalOption::lc_c04: {
      return std::make_unique<LCC04Traversal<ParticleCell_T, PairwiseFunctor_T>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3);
    }
    case TraversalOption::lc_c04_HCP: {
      return std::make_unique<LCC04HCPTraversal<ParticleCell_T, PairwiseFunctor_T>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3);
    }
    case TraversalOption::lc_c08: {
      return std::make_unique<LCC08Traversal<ParticleCell_T, PairwiseFunctor_T>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3);
    }
    case TraversalOption::lc_c18: {
      return std::make_unique<LCC18Traversal<ParticleCell_T, PairwiseFunctor_T>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3);
    }
    // Verlet
    case TraversalOption::vl_list_iteration: {
      return std::make_unique<VLListIterationTraversal<ParticleCell_T, PairwiseFunctor_T>>(&pairwiseFunctor, dataLayout,
                                                                                           useNewton3);
    }
    // Var Verlet Lists
    ...
    case TraversalOption::vlc_sliced: {
      return std::make_unique<VLCSlicedTraversal<ParticleCell_T, PairwiseFunctor_T,
    ...
    case TraversalOption::vlc_sliced_c02: {
      return std::make_unique<VLCSlicedC02Traversal<ParticleCell_T, PairwiseFunctor_T,
                                                    VLCAllCellsNeighborList<typename ParticleCell_T::ParticleType>>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3, ContainerOption::verletListsCells);
    }
    case TraversalOption::vlc_sliced_balanced: {
      return std::make_unique<VLCSlicedBalancedTraversal<
          ParticleCell_T, PairwiseFunctor_T, VLCAllCellsNeighborList<typename ParticleCell_T::ParticleType>>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3, ContainerOption::verletListsCells);
    }
    case TraversalOption::vlc_c01: {
      return std::make_unique<VLCC01Traversal<ParticleCell_T, PairwiseFunctor_T,
                                              VLCAllCellsNeighborList<typename ParticleCell_T::ParticleType>>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3, ContainerOption::verletListsCells);
    }
    case TraversalOption::vlc_c18: {
      return std::make_unique<VLCC18Traversal<ParticleCell_T, PairwiseFunctor_T,
                                              VLCAllCellsNeighborList<typename ParticleCell_T::ParticleType>>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3, ContainerOption::verletListsCells);
    }
    case TraversalOption::vlc_c08: {
      return std::make_unique<VLCC08Traversal<ParticleCell_T, PairwiseFunctor_T,
                                              VLCAllCellsNeighborList<typename ParticleCell_T::ParticleType>>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3);
    }
    ...
    case TraversalOption::vcl_cluster_iteration: {
      return std::make_unique<VCLClusterIterationTraversal<ParticleCell_T, PairwiseFunctor_T>>(
          &pairwiseFunctor, traversalInfo.clusterSize, dataLayout, useNewton3);
    }
    case TraversalOption::vcl_c01_balanced: {
      return std::make_unique<VCLC01BalancedTraversal<typename ParticleCell_T::ParticleType, PairwiseFunctor_T>>(
          &pairwiseFunctor, traversalInfo.clusterSize, dataLayout, useNewton3);
    }
    case TraversalOption::vcl_sliced: {
      return std::make_unique<VCLSlicedTraversal<ParticleCell_T, PairwiseFunctor_T>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          traversalInfo.clusterSize, dataLayout, useNewton3);
    }
    case TraversalOption::vcl_sliced_c02: {
      return std::make_unique<VCLSlicedC02Traversal<ParticleCell_T, PairwiseFunctor_T>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          traversalInfo.clusterSize, dataLayout, useNewton3);
    }
    case TraversalOption::vcl_sliced_balanced: {
      return std::make_unique<VCLSlicedBalancedTraversal<ParticleCell_T, PairwiseFunctor_T>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          traversalInfo.clusterSize, dataLayout, useNewton3);
    }
    case TraversalOption::vcl_c06: {
      return std::make_unique<VCLC06Traversal<ParticleCell_T, PairwiseFunctor_T>>(
          &pairwiseFunctor, traversalInfo.clusterSize, dataLayout, useNewton3);
    }
    ...
    case TraversalOption::vlp_sliced_balanced: {
      return std::make_unique<VLCSlicedBalancedTraversal<
          ParticleCell_T, PairwiseFunctor_T, VLCCellPairNeighborList<typename ParticleCell_T::ParticleType>>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3, ContainerOption::pairwiseVerletLists);
    }
    ...
    case TraversalOption::vlp_c08: {
      return std::make_unique<VLCCellPairC08Traversal<ParticleCell_T, PairwiseFunctor_T>>(
          traversalInfo.cellsPerDim, &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3);
    }
    // Octree
    case TraversalOption::ot_c18: {
      ...
      return std::make_unique<OTC18Traversal<ParticleType, PairwiseFunctor_T>>(
    ...
    case TraversalOption::ot_c01: {
      using ParticleType = typename ParticleCell_T::ParticleType;
      return std::make_unique<OTC01Traversal<ParticleType, PairwiseFunctor_T>>(
          &pairwiseFunctor, traversalInfo.interactionLength, traversalInfo.interactionLength, dataLayout, useNewton3);
    }
    default: {
...
template <class ParticleCell_T>
template <class TriwiseFunctor_T>
std::unique_ptr<TraversalInterface> TraversalSelector<ParticleCell_T>::generateTriwiseTraversal(
    TraversalOption traversalType, TriwiseFunctor_T &triwiseFunctor, const TraversalSelectorInfo &traversalInfo,
    DataLayoutOption dataLayout, bool useNewton3) {
  switch (traversalType) {
    // Direct sum
    case TraversalOption::ds_sequential: {
      return std::make_unique<DSSequentialTraversal<ParticleCell_T, TriwiseFunctor_T>>(
          &triwiseFunctor,
          traversalInfo
              .interactionLength /*this is the cutoff, as generated by DirectSum::getTraversalSelectorInfo()!*/,
          dataLayout, useNewton3);
      ...
      // Linked Cells
    case TraversalOption::lc_c01: {
      return std::make_unique<LCC01Traversal<ParticleCell_T, TriwiseFunctor_T, /*combineSoA*/ false>>(
          traversalInfo.cellsPerDim, &triwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3);
    }
    case TraversalOption::lc_c08: {
      return std::make_unique<LCC08Traversal<ParticleCell_T, TriwiseFunctor_T>>(
          traversalInfo.cellsPerDim, &triwiseFunctor, traversalInfo.interactionLength, traversalInfo.cellLength,
          dataLayout, useNewton3);
    }
    case TraversalOption::lc_c04: {
...
template <class ParticleCell_T>
template <class Functor_T>
std::unique_ptr<TraversalInterface> TraversalSelector<ParticleCell_T>::generateTraversal(
  ...
  if constexpr (utils::isPairwiseFunctor<Functor_T>()) {
    auto pairTraversal =
        generatePairwiseTraversal<Functor_T>(traversalType, functor, traversalInfo, dataLayout, useNewton3);
    ...
    auto triTraversal =
        generateTriwiseTraversal<Functor_T>(traversalType, functor, traversalInfo, dataLayout, useNewton3);
