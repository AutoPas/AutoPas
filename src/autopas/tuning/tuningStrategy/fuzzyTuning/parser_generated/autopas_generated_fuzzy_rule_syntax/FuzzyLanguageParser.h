...
public:
  ...
  enum {
    RuleRule_file = 0, RuleSettings = 1, RuleLinguistic_variable = 2, RuleFuzzy_term = 3, 
    RuleFunction = 4, RuleFuzzy_rule = 5, RuleFuzzy_set = 6, RuleOutput_mapping = 7, 
    RuleOutput_entry = 8, RulePattern_mapping = 9, RuleConfiguration_pattern = 10
  };
