...
#pragma once
#include "autopas/tuning/tuningStrategy/fuzzyTuning/FuzzySet.h"
...
class MembershipFunction {
 public:
   ...
   */
  static const FuzzySet makeTriangle(const std::string &linguisticTerm, double min, double mid, double max);
   ...
   */
  static FuzzySet makeTrapezoid(const std::string &linguisticTerm, double min, double mid1, double mid2, double max);
   ...
   */
  static FuzzySet makeGaussian(const std::string &linguisticTerm, double mean, double sigma);
};
