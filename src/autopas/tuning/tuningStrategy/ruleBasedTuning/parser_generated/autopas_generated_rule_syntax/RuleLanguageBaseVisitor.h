...
public:
  ...
  virtual std::any visitProgram(RuleLanguageParser::ProgramContext *ctx) override {
  ...
  virtual std::any visitLiteral(RuleLanguageParser::LiteralContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitDefine_list(RuleLanguageParser::Define_listContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitVariable(RuleLanguageParser::VariableContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitExpression(RuleLanguageParser::ExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitDefine(RuleLanguageParser::DefineContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitStatement(RuleLanguageParser::StatementContext *ctx) override {
    return visitChildren(ctx);
  }
