...
namespace autopas {
     ...
     */
    [[maybe_unused]] void autopas::OpenMPConfigurator::setChunkSize(int chunkSize) {
     ...
     */
    [[maybe_unused]] [[nodiscard]] OpenMPKindOption autopas::OpenMPConfigurator::getKind() const {
      return _kind;
    }
