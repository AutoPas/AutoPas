...
class VLTraversalInterface {
 public:
  ...
  virtual void setCellsAndNeighborLists(
      std::vector<ParticleCell_T> &cells,
      typename VerletListHelpers<typename ParticleCell_T::ParticleType>::NeighborListAoSType &aosNeighborLists,
 ...
 protected:
   ...
   */
  std::vector<ParticleCell_T> *_cells = nullptr;
  /**
   * The AoS neighbor list of the verlet lists container.
   */
  typename VerletListHelpers<typename ParticleCell_T::ParticleType>::NeighborListAoSType *_aosNeighborLists = nullptr;
  /**
