...
class PseudoVerletLists : public VerletListsLinkedBase<Particle> {
  using verlet_internal = PseudoVerletListHelpers<FullParticleCell<Particle>>;
 ...
 public:
  ...
  PseudoVerletLists(const std::array<double, 3> boxMin, const std::array<double, 3> boxMax, const double cutoff,
                   ...
                   typename PseudoVerletListHelpers<Particle>::PVLBuildType::Value buildType =
                       PseudoVerletListHelpers<Particle>::PVLBuildType::soaBuild)
      : VerletListsLinkedBase<Particle>(boxMin, boxMax, cutoff, skin,
                                        compatibleTraversals::allPVLCompatibleTraversals(), cellSizeFactor),
 ...
 private:
   ...
   */
  typename PseudoVerletListHelpers<Particle>::PVLBuildType::Value _buildType;
};
}  // namespace autopas
