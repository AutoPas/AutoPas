...
class VLCSlicedC02Traversal : public SlicedC02BasedTraversal<ParticleCell_T, PairwiseFunctor>,
...
template <class ParticleCell_T, class PairwiseFunctor, class NeighborList>
inline void VLCSlicedC02Traversal<ParticleCell_T, PairwiseFunctor, NeighborList>::traverseParticles() {
