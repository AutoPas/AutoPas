...
class VLCC01Traversal : public C01BasedTraversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3>,
 ...
 public:
  ...
  {
    switch(typeOfList){
      case 0: return TraversalOption::vlc_c01;
      case 1: return TraversalOption::vlp_c01;
      default: return TraversalOption::vlc_c01;
    }
  }
...
template <class ParticleCell, class PairwiseFunctor, DataLayoutOption::Value dataLayout, bool useNewton3, class NeighborList, int typeOfList>
inline void VLCC01Traversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3, NeighborList, typeOfList>::traverseParticlePairs() {
