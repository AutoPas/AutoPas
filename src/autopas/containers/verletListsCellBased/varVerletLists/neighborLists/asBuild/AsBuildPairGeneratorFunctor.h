...
class AsBuildPairGeneratorFunctor
 ...
 public:
  ...
  void SoAFunctorSingle(SoAView<SoAArraysType> soa, bool newton3) override {
    ...
    auto *const __restrict xptr = soa.template begin<Particle_T::AttributeNames::posX>();
    auto *const __restrict yptr = soa.template begin<Particle_T::AttributeNames::posY>();
    auto *const __restrict zptr = soa.template begin<Particle_T::AttributeNames::posZ>();
  ...
  void SoAFunctorPair(SoAView<SoAArraysType> soa1, SoAView<SoAArraysType> soa2, bool /*newton3*/) override {
    ...
    auto *const __restrict x1ptr = soa1.template begin<Particle_T::AttributeNames::posX>();
    auto *const __restrict y1ptr = soa1.template begin<Particle_T::AttributeNames::posY>();
    auto *const __restrict z1ptr = soa1.template begin<Particle_T::AttributeNames::posZ>();

    auto **const __restrict ptrptr2 = soa2.template begin<Particle_T::AttributeNames::ptr>();
    auto *const __restrict x2ptr = soa2.template begin<Particle_T::AttributeNames::posX>();
    auto *const __restrict y2ptr = soa2.template begin<Particle_T::AttributeNames::posY>();
    auto *const __restrict z2ptr = soa2.template begin<Particle_T::AttributeNames::posZ>();
