...
class VCLSlicedTraversal : public SlicedLockBasedTraversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3>,
 ...
 public:
  ...
  void initTraversal() override {
    ...
    SlicedLockBasedTraversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3>::initTraversal();
  }
  ...
  void endTraversal() override {
    ...
    SlicedLockBasedTraversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3>::endTraversal();
  }
