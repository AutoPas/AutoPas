/**
 * @file VerletClustersBalancedSlicedTraversal.h
 * @author fischerv
 * @date 09 Jun 2020
 */
...
class VerletClustersBalancedSlicedTraversal
 ...
 public:
   ...
   */
  explicit VerletClustersBalancedSlicedTraversal(const std::array<unsigned long, 3> &dims,
                                                 PairwiseFunctor *pairwiseFunctor, const double interactionLength,
                                                 const std::array<double, 3> &cellLength, size_t clusterSize)
  ...
  [[nodiscard]] TraversalOption getTraversalType() const override {
    return TraversalOption::verletClustersBalancedSliced;
  }
  ...
  void initTraversal() override {
    ...
    BalancedSlicedBasedTraversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3>::initTraversal();
  }
  ...
  void endTraversal() override {
    ...
    BalancedSlicedBasedTraversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3>::endTraversal();
  }
