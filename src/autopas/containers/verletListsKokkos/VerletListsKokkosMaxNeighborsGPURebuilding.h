/**
 * @file VerletListsKokkosMaxNeighborsGPURebuilding.h
 * @date 13.06.2026
...
class VerletListsKokkosMaxNeighborsGPURebuilding : public ParticleContainerInterface<Particle_T> {
    public:
    VerletListsKokkosMaxNeighborsGPURebuilding(DataLayoutOption dataLayout, const std::array<double, 3> &boxMin, const std::array<double, 3> &boxMax, double skin, const double cutoff)
    ...
    private:
        ...
        bool buildNeighborListsFlat(const Particle_T::KokkosSoAArraysType& soa1, const Particle_T::KokkosSoAArraysType& soa2, const Kokkos::View<size_t*>& offsets, const Kokkos::View<size_t*>& entries){
            ...
            double startRebuilding = buildTimer.seconds();
