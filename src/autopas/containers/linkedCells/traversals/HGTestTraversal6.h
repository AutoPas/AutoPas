...
class HGTestTraversal6 : public HGTraversalBase<ParticleCell_T>, public HGTraversalInterface {
 public:
  using Particle = typename ParticleCell_T::ParticleType;

  explicit HGTestTraversal6(Functor_T *functor, DataLayoutOption dataLayout, bool useNewton3)
  ...
  void traverseParticles() override {
    ...
    for (size_t upperLevel = 0; upperLevel < this->_numLevels; upperLevel++) {
      ...
      const std::array<size_t, 3> group = {6, 6, 6};
  ...
  [[nodiscard]] TraversalOption getTraversalType() const override { return TraversalOption::hgrid_test6; };
