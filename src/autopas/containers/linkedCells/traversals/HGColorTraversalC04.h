...
class HGColorTraversalC04 : public HGTraversalBase<ParticleCell>, public HGTraversalInterface {
 public:
  using Particle = typename ParticleCell::ParticleType;

  explicit HGColorTraversalC04(Functor *functor, DataLayoutOption dataLayout, bool useNewton3)
  ...
  std::unique_ptr<TraversalInterface> generateNewTraversal(const size_t level) {
    ...
    return std::make_unique<LCC04Traversal<ParticleCell, Functor>>(
  ...
  [[nodiscard]] TraversalOption getTraversalType() const override { return TraversalOption::hgrid_color_c04; };
