...
/**
 * This class provides the base for traversals using the c08 base step for the kokkos-c08-traversal.
 *
 ...
 */
    ...
    private:
        ...
        //        _cellFunctor;
        internal::KokkosCellFunctor<typename ParticleCell::ParticleType, ParticleCell, PairwiseFunctor> _cellFunctor;
        /**
    ...
    template <class ParticleCell, class PairwiseFunctor, DataLayoutOption DataLayout, bool useNewton3>
    inline void C08KokkosCellHandler<ParticleCell, PairwiseFunctor, DataLayout, useNewton3>::processBaseCell(
    ...
    /**
     * method should be exactly as in C08CellHandler.h
     *
     * @tparam ParticleCell
     ...
     */
    template <class ParticleCell, class PairwiseFunctor, DataLayoutOption DataLayout, bool useNewton3>
    inline void C08KokkosCellHandler<ParticleCell, PairwiseFunctor, DataLayout, useNewton3>::computeOffsets(
