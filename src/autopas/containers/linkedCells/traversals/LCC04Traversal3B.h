...
class LCC04Traversal3B : public C08BasedTraversal<ParticleCell, Functor>, public LCTraversalInterface {
 public:
  /**
   ...
   */
  LCC04Traversal3B(const std::array<unsigned long, 3> &dims, Functor *functor, const double interactionLength,
 ...
 */
template <class ParticleCell, class Functor>
constexpr auto LCC04Traversal3B<ParticleCell, Functor>::computeOffsets32Pack() const {
  using std::make_pair;
 ...
 */
template <class ParticleCell, class Functor>
void LCC04Traversal3B<ParticleCell, Functor>::processBasePack32(std::vector<ParticleCell> &cells,
 ...
 */
template <class ParticleCell, class Functor>
void LCC04Traversal3B<ParticleCell, Functor>::traverseParticles() {
...
template <class ParticleCell, class Functor>
void LCC04Traversal3B<ParticleCell, Functor>::traverseSingleColor(std::vector<ParticleCell> &cells, int color) {
