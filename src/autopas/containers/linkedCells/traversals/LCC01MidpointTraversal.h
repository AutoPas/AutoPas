...
class LCC01MidpointTraversal : public C01BasedTraversal<ParticleCell, Functor, (combineSoA ? 2 : 3)>,
 ...
 public:
   ...
   */
  explicit LCC01MidpointTraversal(const std::array<unsigned long, 3> &dims, Functor *functor,
                                  const double interactionLength, const std::array<double, 3> &cellLength,
                                  DataLayoutOption dataLayout, bool useNewton3, std::array<double, 3> boxMin,
...
inline void LCC01MidpointTraversal<ParticleCell, Functor, combineSoA>::computeOffsets() {
...
template <class ParticleCell, class Functor, bool combineSoA>
inline void LCC01MidpointTraversal<ParticleCell, Functor, combineSoA>::computePairwiseOffsets() {
...
template <class ParticleCell, class Functor, bool combineSoA>
inline void LCC01MidpointTraversal<ParticleCell, Functor, combineSoA>::computeTriwiseOffsets() {
...
template <class ParticleCell, class Functor, bool combineSoA>
inline void LCC01MidpointTraversal<ParticleCell, Functor, combineSoA>::processBaseCell(std::vector<ParticleCell> &cells,
...
template <class ParticleCell, class Functor, bool combineSoA>
inline void LCC01MidpointTraversal<ParticleCell, Functor, combineSoA>::processBaseCellPairwise(
    ...
    for (const auto &slice : _cellOffsets) {
      for (auto const &[offset, r] : slice) {
        ...
        if (baseIndex == otherIndex) {
          ...
          this->_cellFunctor.processCellPair(baseCell, otherCell, _boxMin, _boxMax, r);
        }
      }
    }
  }
...
template <class ParticleCell, class Functor, bool combineSoA>
inline void LCC01MidpointTraversal<ParticleCell, Functor, combineSoA>::processBaseCellTriwise(
    std::vector<ParticleCell> &cells, unsigned long x, unsigned long y, unsigned long z) {
  unsigned long baseIndex = utils::ThreeDimensionalMapping::threeToOneD(x, y, z, this->_cellsPerDimension);
  ParticleCell &baseCell = cells[baseIndex];
...
inline void LCC01MidpointTraversal<ParticleCell, PairwiseFunctor, combineSoA>::resizeBuffers() {
...
template <class ParticleCell, class Functor, bool combineSoA>
inline void LCC01MidpointTraversal<ParticleCell, Functor, combineSoA>::traverseParticles() {
