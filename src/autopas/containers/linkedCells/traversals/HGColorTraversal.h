...
class HGColorTraversal : public HGTraversalBase<ParticleCell_T>, public HGTraversalInterface {
 public:
  using Particle = typename ParticleCell_T::ParticleType;

  explicit HGColorTraversal(Functor_T *functor, DataLayoutOption dataLayout, bool useNewton3)
