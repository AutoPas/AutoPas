...
class HGColorTraversal : public HGTraversalBase<ParticleCellT>, public HGTraversalInterface {
 public:
  using Particle = typename ParticleCellT::ParticleType;

  explicit HGColorTraversal(FunctorT *functor, DataLayoutOption dataLayout, bool useNewton3)
