/**
 * @file HGColorTraversalC04Combined.h
 * @author atacann
 * @date 02.01.2025
 */
...
#include "LCC04CombinedSoATraversal.h"
...
class HGColorTraversalC04Combined : public HGTraversalBase<ParticleCell>, public HGTraversalInterface {
 public:
  using Particle = typename ParticleCell::ParticleType;

  explicit HGColorTraversalC04Combined(Functor *functor, DataLayoutOption dataLayout, bool useNewton3)
  ...
  std::unique_ptr<TraversalInterface> generateNewTraversal(const size_t level) {
    ...
    return std::make_unique<LCC04CombinedSoATraversal<ParticleCell, Functor>>(
  ...
  [[nodiscard]] TraversalOption getTraversalType() const override { return TraversalOption::hgrid_color_c04_combined; };
