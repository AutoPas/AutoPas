...
class HGColorSoACellToCell : public HGTraversalBase<ParticleCell_T>, public HGTraversalInterface {
 public:
  using Particle = typename ParticleCell_T::ParticleType;

  explicit HGColorSoACellToCell(Functor_T *functor, DataLayoutOption dataLayout, bool useNewton3)
