...
class C18Traversal : public C18BasedTraversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3>,
 ...
 private:
   ...
   * The vectors (aka std::array<double,3>) describe the imaginative line connecting the center of the base cell and the center of the cell defined
   * by the offset. It is used for sorting.
   */
