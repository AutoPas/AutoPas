...
class ParticleContainerInterface {
 ...
 public:
   ...
   * @param keepNeighborListsValid Defines whether the neighbor lists have to be kept valid. (lgaertner, if true don't
   * delete dummies)
   ...
   * Currently only needed in KokkosCellBasedParticleContainer as updateContainer only marks halo particles as deleted,
   * but actual deletion only happens here.
   *
   */
