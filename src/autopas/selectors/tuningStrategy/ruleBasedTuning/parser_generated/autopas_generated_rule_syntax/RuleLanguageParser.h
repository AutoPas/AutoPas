...
public:
  enum {
    ...
    T__20 = 21, T__21 = 22, T__22 = 23, T__23 = 24, COMMENT = 25, WS = 26, 
    Container_opt = 27, Traversal_opt = 28, Load_estimator_opt = 29, Data_layout_opt = 30, 
    Newton3_opt = 31, Bool_val = 32, Configuration_property = 33, DIGIT = 34, 
    Unsigned_val = 35, Double_val = 36, Variable_name = 37
  };

  enum {
    RuleProgram = 0, RuleUnsigned_val = 1, RuleLiteral = 2, RuleDefine_list = 3, 
    RuleVariable = 4, RuleExpression = 5, RuleDefine = 6, RuleProperty_value = 7, 
    RuleConfiguration_pattern = 8, RuleConfiguration_order = 9, RuleStatement = 10, 
    RuleIf_statement = 11
  };
