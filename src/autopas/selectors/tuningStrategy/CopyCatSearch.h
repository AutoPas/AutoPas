 ...
 */
    ...
    public:
        ...
        void addContainerSelector(/*const*/ ContainerSelector<Particle, ParticleCell> & /*containerSelector*/) override {
            AutoPasLog(trace, "ignoring containerSelector in CopyCatSearch");
        }

        void addParticleCount(int particleCount) {_particles = particleCount;};
    ...
    private:
        ...
        int _configCounter;
        double _particles, _boxLength, _cutoff, _verletSkin;
    };

    template <typename Particle, typename ParticleCell>
    void CopyCatSearch<Particle, ParticleCell>::populateSearchSpace(const std::set<ContainerOption> &allowedContainerOptions,
                                                                 const std::set<TraversalOption> &allowedTraversalOptions,
                                                                 const std::set<DataLayoutOption> &allowedDataLayoutOptions,
                                                                 const std::set<Newton3Option> &allowedNewton3Options) {
        ...
        std::tuple<ContainerOption, TraversalOption, DataLayoutOption, Newton3Option> mloption[] = {
                std::make_tuple(ContainerOption::verletListsCells, TraversalOption::c01, DataLayoutOption::aos, Newton3Option::disabled),
                std::make_tuple(ContainerOption::verletListsCells, TraversalOption::c18, DataLayoutOption::aos, Newton3Option::disabled),
                std::make_tuple(ContainerOption::verletListsCells, TraversalOption::c18, DataLayoutOption::aos, Newton3Option::enabled),
                std::make_tuple(ContainerOption::verletListsCells, TraversalOption::slicedVerlet, DataLayoutOption::aos, Newton3Option::disabled),
                std::make_tuple(ContainerOption::verletListsCells, TraversalOption::slicedVerlet, DataLayoutOption::aos, Newton3Option::enabled),
                std::make_tuple(ContainerOption::verletLists, TraversalOption::verletTraversal, DataLayoutOption::soa, Newton3Option::disabled),
                std::make_tuple(ContainerOption::verletLists, TraversalOption::verletTraversal, DataLayoutOption::soa, Newton3Option::enabled),
                std::make_tuple(ContainerOption::linkedCells, TraversalOption::c08, DataLayoutOption::soa, Newton3Option::disabled),
                std::make_tuple(ContainerOption::linkedCells, TraversalOption::sliced, DataLayoutOption::aos, Newton3Option::disabled),
                std::make_tuple(ContainerOption::linkedCells, TraversalOption::c08, DataLayoutOption::soa, Newton3Option::enabled),
                std::make_tuple(ContainerOption::linkedCells, TraversalOption::c08, DataLayoutOption::aos, Newton3Option::disabled),
                std::make_tuple(ContainerOption::linkedCells, TraversalOption::sliced, DataLayoutOption::soa, Newton3Option::enabled),
                std::make_tuple(ContainerOption::linkedCells, TraversalOption::c08, DataLayoutOption::aos, Newton3Option::enabled),
                std::make_tuple(ContainerOption::linkedCells, TraversalOption::sliced, DataLayoutOption::soa, Newton3Option::disabled),
                std::make_tuple(ContainerOption::linkedCells, TraversalOption::c18, DataLayoutOption::aos, Newton3Option::disabled),
                std::make_tuple(ContainerOption::linkedCells, TraversalOption::c18, DataLayoutOption::soa, Newton3Option::enabled),
                std::make_tuple(ContainerOption::linkedCells, TraversalOption::sliced, DataLayoutOption::aos, Newton3Option::enabled),
                std::make_tuple(ContainerOption::linkedCells, TraversalOption::c18, DataLayoutOption::soa, Newton3Option::disabled),
                std::make_tuple(ContainerOption::linkedCells, TraversalOption::c01, DataLayoutOption::aos, Newton3Option::disabled),
                std::make_tuple(ContainerOption::linkedCells, TraversalOption::c18, DataLayoutOption::aos, Newton3Option::enabled),
                std::make_tuple(ContainerOption::linkedCells, TraversalOption::c01, DataLayoutOption::soa, Newton3Option::disabled),
                std::make_tuple(ContainerOption::verletLists, TraversalOption::verletTraversal, DataLayoutOption::aos, Newton3Option::enabled),
                std::make_tuple(ContainerOption::verletLists, TraversalOption::verletTraversal, DataLayoutOption::aos, Newton3Option::disabled),
        };
        */
        ...
        const auto result = model.predict(
                {fdeep::tensor5(fdeep::shape5(1, 1, 1, 1, 4), {_particles/max_particle_count, _boxLength/max_box_length,
                                                               _cutoff/max_cutoff, _verletSkin/max_v_skin_rad})});
        std::cout << fdeep::show_tensor5s(result) << std::endl;
        std::vector<float> vec = *result[0].as_vector();

        auto find_min = [](auto input) {
            int min = 0;
            for (int i = 0; i < 23; ++i)
        ...
        while (_currentConfig != _searchSpace.end()) {
            ...
            for (int i = 0; i < 5; ++i)
                if (_configCounter == _mlSuggestions[i])
                    isSuggestion = true;
    ...
    bool CopyCatSearch<Particle, ParticleCell>::tune() {
        AutoPasLog(debug, "You are in CopyCatSearch");
