  ...
  switch (traversalType) {
    ...
    case TraversalOption::vlc_sliced: {
      return std::make_unique<VLCSlicedTraversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3,
                                                 VerletListsCellsNeighborList<typename ParticleCell::ParticleType>, TraversalOption::vlc_sliced>>(
          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
    }
    case TraversalOption::vlc_sliced_c02: {
      return std::make_unique<
          VLCSlicedC02Traversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3,
                                VerletListsCellsNeighborList<typename ParticleCell::ParticleType>, TraversalOption::vlc_sliced_c02>>(
          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
    }
    ...
    case TraversalOption::vlp_sliced: {
      return std::make_unique<VLCSlicedTraversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3,
                                                 PairwiseVerletNeighborList<typename ParticleCell::ParticleType>, TraversalOption::vlp_sliced>>(
          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
    }
    case TraversalOption::vlp_sliced_c02: {
      return std::make_unique<
          VLCSlicedC02Traversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3,
                                PairwiseVerletNeighborList<typename ParticleCell::ParticleType>, TraversalOption::vlp_sliced_c02>>(
          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
    }
