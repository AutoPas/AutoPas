...
std::unique_ptr<TraversalInterface> TraversalSelector<ParticleCell>::generateTraversal(
  ...
  switch (traversalType) {
      ...
      //          &pairwiseFunctor,
      //          info.interactionLength /*this is the cutoff, as generated by
      //          DirectSum::getTraversalSelectorInfo()!*/);
      //    }
      //    // Linked cell
      ...
      //      return std::make_unique<VVLAsBuildTraversal<ParticleCell, typename ParticleCell::ParticleType,
      //      PairwiseFunctor,
      ...
      //                                                    VLCAllCellsNeighborList<typename
      //                                                    ParticleCell::ParticleType>,
      //                                                    ContainerOption::verletListsCells>>(
      //          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
      //    }
      ...
      //      return std::make_unique<VCLClusterIterationTraversal<ParticleCell, PairwiseFunctor, dataLayout,
      //      useNewton3>>(
      //          &pairwiseFunctor, info.clusterSize);
      //    }
      //    case TraversalOption::vcl_c01_balanced: {
      //      return std::make_unique<
      //          VCLC01BalancedTraversal<typename ParticleCell::ParticleType, PairwiseFunctor, dataLayout,
      //          useNewton3>>( &pairwiseFunctor, info.clusterSize);
      //    }
      ...
      //      return std::make_unique<VCLSlicedBalancedTraversal<ParticleCell, PairwiseFunctor, dataLayout,
      //      useNewton3>>(
      //          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength, info.clusterSize);
      //    }
      //    case TraversalOption::vcl_c06: {
      //      return std::make_unique<VCLC06Traversal<ParticleCell, PairwiseFunctor, dataLayout,
      //      useNewton3>>(&pairwiseFunctor,
      //                                                                                                      info.clusterSize);
      //    }
      ...
      //      return std::make_unique<VLCSlicedC02Traversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3,
      //                                                    VLCCellPairNeighborList<typename
      //                                                    ParticleCell::ParticleType>,
      //                                                    ContainerOption::pairwiseVerletLists>>(
      //          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
      //    }
