...
std::unique_ptr<TraversalInterface> TraversalSelector<ParticleCell>::generateTraversal(
  ...
  switch (traversalType) {
    ...
    case TraversalOption::vlc_sliced: {
      return std::make_unique<VLCSlicedTraversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3, typename VerletListsCellsHelpers<typename ParticleCell::ParticleType>::NeighborListsType, 0>>(
          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
    }
    case TraversalOption::vlc_sliced_c02: {
      return std::make_unique<VLCSlicedC02Traversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3, typename VerletListsCellsHelpers<typename ParticleCell::ParticleType>::NeighborListsType, 0>>(
          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
    }
    case TraversalOption::vlc_sliced_balanced: {
      return std::make_unique<VLCSlicedBalancedTraversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3, typename VerletListsCellsHelpers<typename ParticleCell::ParticleType>::NeighborListsType, 0>>(
          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
    }
    case TraversalOption::vlc_c01: {
      return std::make_unique<VLCC01Traversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3, typename VerletListsCellsHelpers<typename ParticleCell::ParticleType>::NeighborListsType, 0>>(
          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
    }
    case TraversalOption::vlc_c18: {
      return std::make_unique<VLCC18Traversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3, typename VerletListsCellsHelpers<typename ParticleCell::ParticleType>::NeighborListsType, 0>>(
          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
    }
    ...
    case TraversalOption::vlp_sliced: {
      return std::make_unique<VLCSlicedTraversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3, typename VerletListsCellsHelpers<typename ParticleCell::ParticleType>::PairwiseNeighborListsType, 1>>(
          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
    }
    case TraversalOption::vlp_sliced_c02: {
      return std::make_unique<VLCSlicedC02Traversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3, typename VerletListsCellsHelpers<typename ParticleCell::ParticleType>::PairwiseNeighborListsType, 1>>(
          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
    }
    case TraversalOption::vlp_sliced_balanced: {
      return std::make_unique<VLCSlicedBalancedTraversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3, typename VerletListsCellsHelpers<typename ParticleCell::ParticleType>::PairwiseNeighborListsType, 1>>(
          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
    }
    case TraversalOption::vlp_c01: {
      return std::make_unique<VLCC01Traversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3, typename VerletListsCellsHelpers<typename ParticleCell::ParticleType>::PairwiseNeighborListsType, 1>>(
          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
    }
    case TraversalOption::vlp_c18: {
      return std::make_unique<VLCC18Traversal<ParticleCell, PairwiseFunctor, dataLayout, useNewton3, typename VerletListsCellsHelpers<typename ParticleCell::ParticleType>::PairwiseNeighborListsType, 1>>(
          info.dims, &pairwiseFunctor, info.interactionLength, info.cellLength);
    }
  }
