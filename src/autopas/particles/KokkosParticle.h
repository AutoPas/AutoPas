...
//template <typename floatType>
  ...
  public:
      ...
      KokkosParticle(std::array<double, 3> r, std::array<double, 3> v, unsigned long id): Particle() {
      #ifdef AUTOPAS_KOKKOS
        //create views
        _r = FloatVectorType("_r", 3);
        _v = FloatVectorType("_v", 3);
...
#ifdef AUTOPAS_KOKKOS
      FloatVectorType get_r() const{
        return _r;
      }


      FloatVectorType get_v() {
        return _v;
      }
      FloatVectorType get_f() {
        return _f;
      }
      ...
      */
      ...
      void subF(FloatVectorType &f) {
        KokkosHelper::subDir(_f, f);
      }
      ...
      */
      ...
      void addR(FloatVectorType &r) {
        KokkosHelper::addDir(_r, r);
      }
      ...
      */
      ...
      void subR(FloatVectorType &r) {
        KokkosHelper::subDir(_r, r);
      }
      ...
      */
      ...
      void addV(FloatVectorType &v) {
        KokkosHelper::addDir(_v, v);
      }
      ...
      FloatVectorType get_r_inline() const{
        return _r;
      }

      KOKKOS_INLINE_FUNCTION
      FloatVectorType get_f_inline() const{
        return _f;
      }
#endif
