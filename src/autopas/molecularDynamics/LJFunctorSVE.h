...
class LJFunctorSVE
 ...
 public:
  ...
  bool allowsMixedNewton3CallsForGlobals() final { return false; }
 ...
 private:
  ...
  void SoAFunctorSingleImpl(SoAView<SoAArraysType> soa) {
    ...
    if constexpr (calculateGlobals) {
      ...
      if (newton3) {
        _aosThreadData[threadnum].upotSumN3 += svaddv_f64(svptrue_b64(), upotSum) * 0.5;
        ...
        _aosThreadData[threadnum].upotSumNoN3 += svaddv_f64(svptrue_b64(), upotSum);
