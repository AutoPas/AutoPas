...
#include "autopas/kokkosContainers/kokkosCellPairTraversals/KokkosC01BasedTraversal.h"
...
class KokkosLCC01Traversal
 ...
 private:
   ...
   */
  inline void processBaseCell(Kokkos::View<ParticleCell *> &cells, unsigned long x, unsigned long y, unsigned long z);
