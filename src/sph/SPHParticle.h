...
class SPHParticle : public autopas::Particle {
 public:
  ...
  double addDensity(double density) { _density += density; }
  ...
  double getSmth() const { return _smth; }

  void setSmth(double smth) { _smth = smth; }

  double getSnds() const { return _snds; }

  void setSnds(double snds) { _snds = snds; }
  ...
  const std::array<double, 3> &getAcc() const { return _acc; }

  void addAcc(const std::array<double, 3> &acc);

  void subAcc(const std::array<double, 3> &acc);

  void setAcc(const std::array<double, 3> &acc) { _acc = acc; }

  double getEngDot() const { return _eng_dot; }

  void addEngDot(double eng_dot) { _eng_dot += eng_dot; }

  void setEngDot(double eng_dot) { _eng_dot = eng_dot; }

  double getEng() const { return _eng; }

  void setEng(double eng) { _eng = eng; }
