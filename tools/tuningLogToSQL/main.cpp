...
/**
* This program converts files written by the TuningStrategyLoggerWrapper into a SQLite database file `out.db` for easy data analysis. It already creates some interesting views on the data.
* See README.md.
*/
