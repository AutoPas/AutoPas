...
# Working directory
WORK_DIR=$HOME/code-server/scratch_space/tmp/$WORK_DIR_SUFFIX
...
# debugging
echo "Currently generating code for configuration: TI: $TI, TJ: $TJ, TK: $TK, UI: $UI, UJ: $UJ, UK: $UK"

# remove previous variant of the kernel and the result

rm -rf rmatmult3_at.so rmatmult3_at_modified.c temp.script peri.result.overall peri.result.iters

# output filename
out_file=rmatmult3_${TI}_${TJ}_${TK}_${UI}_${UJ}_${UK}.so
