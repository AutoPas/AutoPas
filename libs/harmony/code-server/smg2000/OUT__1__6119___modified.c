...
extern void OUT__1__6119__(void **__out_argv)
  {
    ...
    over1 = 0;
    over2 = 0;
    for (t2 = 0; t2 <= hypre__mz - 1; t2 += 23)
      {
        for (t4 = 0; t4 <= hypre__my - 1; t4 += 39)
          {
            for (t6 = 0; t6 <= hypre__mx - 1; t6 += 55)
              {
                for (t8 = t2; t8 <= __suif_min(t2 + 22, hypre__mz - 1); t8++)
                  {
                    for (t10 = t4; t10 <= __suif_min(t4 + 38, hypre__my - 1); t10++)
                      {
                        over1 = stencil_size % 6;
                        for (t12 = 0; t12 <= -over1 + stencil_size - 1; t12 += 6)
                          {
                            over2 = (5 * t6 + hypre__mx) % 6;
                            for (t14 = t6; t14 <= __suif_min(t6 + 48, hypre__mx - over2 - 1); t14 += 6)
                              {
                            ...
                            for (t14 = __suif_max(hypre__mx - over2, t6); t14 <= __suif_min(hypre__mx - 1, t6 + 54); t14++)
                              {
                                suif_tmp = &rp[ri + t14 + t10 * hypre__sy3 + t8 * hypre__sz3];
                                *suif_tmp = *suif_tmp - Ap_0[t14 + t10 * hypre__sy1 + t8 * hypre__sz1 + A->data_indices[i][t12]] * xp_0[t14 + t10 * hypre__sy2 + t8 * hypre__sz2 + ((int *)dxp_s)[t12]];
                                suif_tmp = &rp[ri + t14 + t10 * hypre__sy3 + t8 * hypre__sz3];
                            ...
                            if (over2 + t14 + 1 <= hypre__mx)
                              {
                                suif_tmp = &rp[ri + t6 + 54 + t10 * hypre__sy3 + t8 * hypre__sz3];
                                *suif_tmp = *suif_tmp - Ap_0[t6 + 54 + t10 * hypre__sy1 + t8 * hypre__sz1 + A->data_indices[i][t12]] * xp_0[t6 + 54 + t10 * hypre__sy2 + t8 * hypre__sz2 + ((int *)dxp_s)[t12]];
                                suif_tmp = &rp[ri + t6 + 54 + t10 * hypre__sy3 + t8 * hypre__sz3];
                                *suif_tmp = *suif_tmp - Ap_0[t6 + 54 + t10 * hypre__sy1 + t8 * hypre__sz1 + A->data_indices[i][t12 + 1]] * xp_0[t6 + 54 + t10 * hypre__sy2 + t8 * hypre__sz2 + ((int *)dxp_s)[t12 + 1]];
                                suif_tmp = &rp[ri + t6 + 54 + t10 * hypre__sy3 + t8 * hypre__sz3];
                                *suif_tmp = *suif_tmp - Ap_0[t6 + 54 + t10 * hypre__sy1 + t8 * hypre__sz1 + A->data_indices[i][t12 + 2]] * xp_0[t6 + 54 + t10 * hypre__sy2 + t8 * hypre__sz2 + ((int *)dxp_s)[t12 + 2]];
                                suif_tmp = &rp[ri + t6 + 54 + t10 * hypre__sy3 + t8 * hypre__sz3];
                                *suif_tmp = *suif_tmp - Ap_0[t6 + 54 + t10 * hypre__sy1 + t8 * hypre__sz1 + A->data_indices[i][t12 + 3]] * xp_0[t6 + 54 + t10 * hypre__sy2 + t8 * hypre__sz2 + ((int *)dxp_s)[t12 + 3]];
                                suif_tmp = &rp[ri + t6 + 54 + t10 * hypre__sy3 + t8 * hypre__sz3];
                                *suif_tmp = *suif_tmp - Ap_0[t6 + 54 + t10 * hypre__sy1 + t8 * hypre__sz1 + A->data_indices[i][t12 + 4]] * xp_0[t6 + 54 + t10 * hypre__sy2 + t8 * hypre__sz2 + ((int *)dxp_s)[t12 + 4]];
                              }
                            else
                              {
                                suif_tmp = &rp[ri + t6 + 54 + t10 * hypre__sy3 + t8 * hypre__sz3];
                                *suif_tmp = *suif_tmp - Ap_0[t6 + 54 + t10 * hypre__sy1 + t8 * hypre__sz1 + A->data_indices[i][t12 + 5]] * xp_0[t6 + 54 + t10 * hypre__sy2 + t8 * hypre__sz2 + ((int *)dxp_s)[t12 + 5]];
                              }
                          }
                        for (t12 = __suif_max(stencil_size - over1, 0); t12 <= stencil_size - 1; t12++)
                          {
                            for (t14 = t6; t14 <= __suif_min(t6 + 54, hypre__mx - 1); t14++)
                              {
                                suif_tmp = &rp[ri + t14 + t10 * hypre__sy3 + t8 * hypre__sz3];
                                *suif_tmp = *suif_tmp - Ap_0[t14 + t10 * hypre__sy1 + t8 * hypre__sz1 + A->data_indices[i][t12]] * xp_0[t14 + t10 * hypre__sy2 + t8 * hypre__sz2 + ((int *)dxp_s)[t12]];
                              }
