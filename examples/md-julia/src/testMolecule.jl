...
module enumMod
  using CxxWrap
  # @wrapmodule(joinpath("/mnt/c/Users/laura/Documents/BA_SH/autopas_/AutoPas/build/examples/md-julia/","libjulia_bindings.so"))
  @wrapmodule(joinpath("../../../build/examples/md-julia/","libjulia_bindings.so"), :define_module_enum)
...
println("position of molecule: " * string(get_pos))
...
it = autopas.IteratorBehavior(enumMod.owned)
