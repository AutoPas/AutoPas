...
JLCXX_MODULE define_module_iterators(jlcxx::Module& mod) {
    ...
    mod.add_type<Parametric<TypeVar<1>, TypeVar<2>>>("ParticleIteratorInterface")
            .apply<autopas::ParticleIteratorInterface<MoleculeJ<double>, true>>(WrapIteratorInterface());
     ...
     * 2) MoleculeJ<double>, true 
     */
    mod.add_type<Parametric<TypeVar<1>, TypeVar<2>>>("ParticleIteratorWrapper", jlcxx::julia_base_type<autopas::ParticleIteratorInterface<MoleculeJ<double>, true>>())
            .apply<autopas::ParticleIteratorWrapper<MoleculeJ<double>, true>>(WrapIteratorWrapper());
