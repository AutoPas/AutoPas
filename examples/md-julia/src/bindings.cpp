...
#include "MoleculeJ.h"
#include <iostream>
#include "./bindings/BindingHeaders.h"
...
JLCXX_MODULE define_module_autopas(jlcxx::Module& mod)
{
    ...
    mod.add_type<Parametric<TypeVar<1>>>("AutoPas")
            .apply<autopas::AutoPas<MoleculeJ<double>>>(WrapAutoPas());
...
// cmake -DMD_FLEXIBLE_USE_MPI=OFF -DMD_FLEXIBLE_FUNCTOR_AUTOVEC=OFF -DCMAKE_POSITION_INDEPENDENT_CODE=ON -DAUTOPAS_BUILD_TESTS=OFF -DCMAKE_CXX_COMPILER=g++-11.2.0 -DAUTOPAS_OPENMP=OFF ..
