...
" >| "${containerPrefixes[$containerIndex]}${data_layout}Sites${site_count}Density${density}$functor.yaml"
}
  ...
  for site_count in "${site_counts[@]}"; do
    for density in "${densities[@]}"; do
      for threads in "${num_threads[@]}";do
        filename="${containerPrefixes[containerIndex]}${data_layout}Sites${site_count}Density${density}${functor}.yaml"
