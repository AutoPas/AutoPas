...
//void Generator<Particle, ParticleCell>::CubeGrid(autopas::AutoPas<Particle, ParticleCell> &autopas,
...
//
//template <class Particle, class ParticleCell>
//void Generator<Particle, ParticleCell>::Gauss(autopas::AutoPas<Particle, ParticleCell> &autopas,
...
//
//template <class Particle, class ParticleCell>
//void Generator<Particle, ParticleCell>::Random(autopas::AutoPas<Particle, ParticleCell> &autopas,
//                                               double boxLength, size_t numParticles) {
//    std::array<double, 3> boxMin({0., 0., 0.});
//    std::array<double, 3> boxMax({boxLength, boxLength, boxLength});
//
