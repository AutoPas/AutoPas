...
#else
using LJFunctorTypeAutovec = mdLib::LJFunctor<ParticleType, false, false, false, false, autopas::FunctorN3Modes::Both,
                                              mdFlexibleTypeDefs::calcGlobals, mdFlexibleTypeDefs::countFLOPs>;
#endif
...
#else
using ATFunctor = mdLib::AxilrodTellerFunctor<ParticleType, false,true , true,autopas::FunctorN3Modes::Both,
                                              mdFlexibleTypeDefs::calcGlobals, mdFlexibleTypeDefs::countFLOPs>;
