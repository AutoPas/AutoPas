...
#else
using ATFunctor = mdLib::AxilrodTellerFunctor<ParticleType, true, /*useLUT*/ true>;  // Changed
#endif
...
using ATFunctorTypeAbstract = mdLib::AxilrodTellerFunctor<ParticleType, true, /*useLUT*/ true>;  // Changed
#endif
