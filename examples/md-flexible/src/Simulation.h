...
class Simulation {
 ...
 private:
  ...
  void applyStrainStressResizing(const double SumOfForcesOnXUpperWall, const double pressure, const double damping_coeff, const double startBoxMaxY, const double finalBoxMaxY, const size_t starting_iteration, const double minRadius);
