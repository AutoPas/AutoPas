...
constexpr std::array<typename ParticleType::AttributeNames, 24> Attributes = {
    ...
    mdLib::PositionStoringMultiSiteMolecule::AttributeNames::absoluteSitePositionsX,
    mdLib::PositionStoringMultiSiteMolecule::AttributeNames::absoluteSitePositionsY,
    mdLib::PositionStoringMultiSiteMolecule::AttributeNames::absoluteSitePositionsZ,
