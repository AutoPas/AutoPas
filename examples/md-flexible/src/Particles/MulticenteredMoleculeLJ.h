 ...
 public:
   ...
   * The reason for this is the easier use of the value in calculations (See LJFunctor "energyFactor")
   ...
   using SoAArraysType = typename autopas::utils::SoAType<
         MulticenteredMoleculeLJ *, size_t /*id*/, double /*x*/, double /*y*/, double /*z*/, double /*vx*/,
         double /*vy*/, double /*vz*/, double /*fx*/, double /*fy*/, double /*fz*/, double /*oldFx*/,
         double /*oldFy*/, double /*oldFz*/, double /*q0*/, double /*q1*/, double /*q2*/, double /*q3*/,
         double /*angVx*/, double /*angVy*/, double /*angVz*/, double /*tx*/, double /*ty*/, double /*tz*/,
