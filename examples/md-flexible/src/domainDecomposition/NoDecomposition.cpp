...
NoDecomposition::NoDecomposition(int argc, char **argv, const int &dimensionCount,
...
void NoDecomposition::initializeGlobalBox(const std::vector<double> &globalBoxMin,
