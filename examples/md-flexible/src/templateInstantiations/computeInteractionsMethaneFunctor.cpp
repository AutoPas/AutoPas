/**
 * @file computeInteractionsMethaneFunctor.cpp
 *
 * Contains an explicit template instantiation for the computeInteractions() method with the appropriate auto-vectorized
 * Methane Functor and Particle Type, as determined by whether md-flexible is compiled with or without Multi-Site
...
template bool autopas::AutoPas<ParticleType>::computeInteractions(MethaneFunctor *);
//! @endcond
