/**
 * @file computeInteractionsATMFunctorHWY.cpp
 *
 * Contains an explicit template instantiation for the computeInteractions() method with the Google Highway vectorized
...
template bool autopas::AutoPas<ParticleType>::computeInteractions(ATMFunctorHWY *);
//! @endcond
