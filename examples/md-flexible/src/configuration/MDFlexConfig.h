...
class MDFlexConfig {
 public:
  ...
  MDFlexOption<unsigned int, __LINE__> explorationSamples{
      100, "exploration-samples", true, "For the deep reinforcement learning tuning strategy: Number of configurations to explore during the exploration phase. This value has to be greater than one."};
