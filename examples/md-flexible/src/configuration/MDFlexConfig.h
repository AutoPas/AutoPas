...
class MDFlexConfig {
 public:
   ...
   */
  enum class FunctorOption { lj12_6, lj12_6_AVX, lj12_6_SVE, lj12_6_Globals, lj12_6_AVX_STS, lj12_6_AVX512_Mask };
  ...
  MDFlexOption<FunctorOption, __LINE__> functorOption {
    ...
    FunctorOption::lj12_6,
        ...
        "lennard-jones-AVX lennard-jones-SVE lennard-jones-globals lennard-jones-AVX-gather-scatter lennard-jones-AVX-site-to-site)"
  };
  /**
   * iterations
   */
