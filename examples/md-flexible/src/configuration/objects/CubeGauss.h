...
class CubeGauss : public Object {
 public:
   ...
   */
  CubeGauss(const std::array<CalcType, 3> &velocity, unsigned long typeId, size_t numParticles,
            const std::array<CalcType, 3> &boxLength, const std::array<CalcType, 3> &distributionMean,
            const std::array<CalcType, 3> &distributionStdDev, const std::array<CalcType, 3> &bottomLeftCorner)
   ...
   */
  [[nodiscard]] const std::array<CalcType, 3> &getDistributionMean() const { return _distributionMean; }

  /**
   * Getter for distributionStdDev.
   * @return distributionStdDev
   */
  [[nodiscard]] const std::array<CalcType, 3> &getDistributionStdDev() const { return _distributionStdDev; }
 ...
 private:
   ...
   */
  std::array<CalcType, 3> _distributionMean;

  /**
   * The standard deviation value for the gaussian distribution of the particles.
   */
  std::array<CalcType, 3> _distributionStdDev;
