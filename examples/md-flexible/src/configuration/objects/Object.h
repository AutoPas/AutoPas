...
class Object {
 public:
   ...
   * @param typeId
   */
  Object(const std::array<CalcType, 3> &velocity, unsigned long typeId) : _velocity(velocity), _typeId(typeId) {}
   ...
   * @return velocity
   */
  [[nodiscard]] const std::array<CalcType, 3> &getVelocity() const { return _velocity; }
   ...
   */
  [[nodiscard]] virtual std::array<CalcType, 3> getBoxMin() const = 0;

  /**
   * Getter for the highest x,y,z coordinates for Object
   * @return BoxMax of Cube
   */
  [[nodiscard]] virtual std::array<CalcType, 3> getBoxMax() const = 0;
   ...
   */
  [[nodiscard]] virtual CalcType getParticleSpacing() const { return 0; }
 ...
 protected:
   ...
   */
  std::array<CalcType, 3> _velocity;
  /**
