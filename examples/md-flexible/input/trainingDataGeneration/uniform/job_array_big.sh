...
cd noParticles_${noParticles[${SLURM_ARRAY_TASK_ID}]}/${thread_count[${SLURM_ARRAY_TASK_ID}]}_threads/skin_${verlet_skin[${SLURM_ARRAY_TASK_ID}]}/run_${run[${SLURM_ARRAY_TASK_ID}]}
