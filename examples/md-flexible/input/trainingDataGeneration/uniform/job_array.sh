#!/bin/bash
#SBATCH --job-name=Uni_S_Job_Array
#SBATCH --nodes=1
...
cd noParticles_${noParticles[${SLURM_ARRAY_TASK_ID}]}/${thread_count[${SLURM_ARRAY_TASK_ID}]}_threads/skin_${verlet_skin[${SLURM_ARRAY_TASK_ID}]}/
