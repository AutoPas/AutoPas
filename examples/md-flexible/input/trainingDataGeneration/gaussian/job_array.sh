#!/bin/bash
#SBATCH --job-name=Gauss_Job_Array
#SBATCH --nodes=1
...
cd noClusters_${noClusters[${SLURM_ARRAY_TASK_ID}]}/${thread_count[${SLURM_ARRAY_TASK_ID}]}_threads/skin_${verlet_skin[${SLURM_ARRAY_TASK_ID}]}
