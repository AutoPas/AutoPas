...
# Uses the template_input.yaml to creates various input files that emulate an empty
# simulation domain with different thread counts and skin sizes. For each scenario,
# 5 repeat runs are made.
