...
TEST_F(FullSearchMPITest, testSearchSpaceMoreOptions) {
  ...
  EXPECT_FALSE(fullSearchMPI.searchSpaceIsEmpty());
  EXPECT_THAT(fullSearchMPI.getAllowedContainerOptions(),
...
// manually set every rank to 0, because we cannot use WrapMPI here
  ...
  rank = 0;
#endif
  autopas::FullSearchMPI fullSearchMPI({autopas::Configuration(
      autopas::ContainerOption::directSum, 1. + (double)rank / 10., autopas::TraversalOption::directSumTraversal,
      autopas::DataLayoutOption::soa, autopas::Newton3Option::enabled)});
...
TEST_F(FullSearchMPITest, testLocalOptimumAndReset) {
  autopas::FullSearchMPI fullSearchMPI(
      {autopas::Configuration(autopas::ContainerOption::directSum, 1., autopas::TraversalOption::directSumTraversal,
                              autopas::DataLayoutOption::soa, autopas::Newton3Option::enabled),
       autopas::Configuration(autopas::ContainerOption::linkedCells, 1.2, autopas::TraversalOption::c08,
       ...
       autopas::Configuration(autopas::ContainerOption::verletClusterLists, 1.,
                              autopas::TraversalOption::c01CombinedSoA, autopas::DataLayoutOption::soa,
                              autopas::Newton3Option::enabled)});
  ...
  EXPECT_EQ(autopas::Configuration(autopas::ContainerOption::linkedCells, 1.2, autopas::TraversalOption::c08,
                                   autopas::DataLayoutOption::aos, autopas::Newton3Option::enabled),
            fullSearchMPI.getCurrentConfiguration());
...
TEST_F(FullSearchMPITest, testInvalidConfigs) {
  ...
  EXPECT_EQ(
      autopas::Configuration(autopas::ContainerOption::verletClusterLists, 1., autopas::TraversalOption::c01CombinedSoA,
                             autopas::DataLayoutOption::soa, autopas::Newton3Option::enabled),
      fullSearchMPI.getCurrentConfiguration());
}
