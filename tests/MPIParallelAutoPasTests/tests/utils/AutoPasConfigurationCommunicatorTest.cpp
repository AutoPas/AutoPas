...
// ToDo the following tests, test functions of AutoPasConfigurationCommunicatorTest no longer used. The tests may still
// be valuable, but should instead test MPIParallelizedStrategy
