...
public:
    ...
    ThermostatTest()
            ...
            _particlePropertiesLibrary(ParticlePropertiesLibrary<double, size_t>()),
              _timeDiscretization(TimeDiscretization<decltype(_autopas), std::remove_reference_t<decltype(_particlePropertiesLibrary)>>(0.002 /*delta_t*/,_particlePropertiesLibrary))
...
protected:
    ...
    TimeDiscretization<decltype(_autopas), std::remove_reference_t<decltype(_particlePropertiesLibrary)>> _timeDiscretization;
