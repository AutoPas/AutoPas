...
TEST_F(GeneratorsTest, MultipleObjectGeneration) {
  ...
  size_t idcounter=0;  //to avoid multiple particles with the same ids
    ...
    Generator::CubeGrid(autoPas,CubeGrid.at(0).getTypeId(),idcounter, CubeGrid.at(0).getBoxMin(), CubeGrid.at(0).getParticlesPerDim(), CubeGrid.at(0).getParticleSpacing(), CubeGrid.at(0).getVelocity());
    idcounter+=CubeGrid.at(0).getParticlesTotal();

    Generator::CubeGauss(autoPas,CubeGauss.at(0).getTypeId(),idcounter, CubeGauss.at(0).getBoxMin(), CubeGauss.at(0).getBoxMax(), CubeGauss.at(0).getParticlesTotal(),CubeGauss.at(0).getDistributionMean(),
                         CubeGauss.at(0).getDistributionStdDev(), CubeGauss.at(0).getVelocity());
      idcounter+=CubeGauss.at(0).getParticlesTotal();

    Generator::CubeRandom(autoPas,CubeUniform.at(0).getTypeId(),idcounter, CubeUniform.at(0).getBoxMin(),CubeUniform.at(0).getBoxMax(),CubeUniform.at(0).getParticlesTotal(), CubeUniform.at(0).getVelocity());
      idcounter+=CubeUniform.at(0).getParticlesTotal();

    Generator::Sphere(autoPas, Sphere.at(0).getCenter(),Sphere.at(0).getRadius(), Sphere.at(0).getParticleSpacing(), idcounter,Sphere.at(0).getTypeId(), Sphere.at(0).getVelocity());
