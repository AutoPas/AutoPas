...
#endif
  autopas::C08Traversal<FPCell, MCellFunctor> c08Traversal({edgeLength, edgeLength, edgeLength}, &cellFunctor);
...
TEST_F(C08TraversalTest, testTraversal2x3x4) {
  ...
  omp_set_num_threads(4);
#endif
  autopas::C08Traversal<FPCell, MCellFunctor> c08Traversal({edgeLength[0], edgeLength[1], edgeLength[2]}, &cellFunctor);
