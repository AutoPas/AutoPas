...
class MockTriwiseFunctor : public autopas::TriwiseFunctor<Particle_T, MockTriwiseFunctor<Particle_T>> {
 public:
  ...
  MOCK_METHOD(void, SoAFunctorVerletIntersection,
            (autopas::SoAView<typename Particle_T::SoAArraysType> soa, size_t indexFirst,
             (const std::vector<std::vector<size_t, autopas::AlignedAllocator<size_t>>> &), bool newton3),
            (override));

  MOCK_METHOD(void, SoAFunctorVerletPair,
            (autopas::SoAView<typename Particle_T::SoAArraysType> soa, size_t indexFirst,
             (const std::vector<std::pair<size_t, size_t>, autopas::AlignedAllocator<std::pair<size_t, size_t>>> &), bool newton3),
            (override));
