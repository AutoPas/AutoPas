/**
 * @file NiceMockPairwiseFunctor.h
...
class NiceMockPairwiseFunctor : public autopas::PairwiseFunctor<Particle, NiceMock<NiceMockPairwiseFunctor<Particle>>> {
 public:
  NiceMockPairwiseFunctor() : autopas::PairwiseFunctor<Particle, NiceMockPairwiseFunctor<Particle>>(0.){};
