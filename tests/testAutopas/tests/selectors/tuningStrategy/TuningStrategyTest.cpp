...
TEST_P(TuningStrategyTest, testSearchSpaceEmpty) {
  ...
  EXPECT_THROW(
      autopas::TuningStrategyFactory::generateTuningStrategy(tuningStrategy, {}, noInterval, {}, {}, {}, {}, 42, 1.2, 5, 10, false,
...
TEST_P(TuningStrategyTest, testSearchSpaceOneOption) {
  ...
  auto search = autopas::TuningStrategyFactory::generateTuningStrategy(
      ...
      {autopas::DataLayoutOption::soa}, {autopas::Newton3Option::enabled}, 42, 1.2, 5, 10, false, 3,
...
TEST_P(TuningStrategyTest, testSearchSpaceMoreOptions) {
  ...
  auto search = autopas::TuningStrategyFactory::generateTuningStrategy(
      ...
      {autopas::Newton3Option::enabled, autopas::Newton3Option::disabled}, 1, 1.2, 5, 10, false, 3,
      autopas::AcquisitionFunctionOption::expectedImprovement, autopas::ExtrapolationMethodOption::linePrediction);
...
TEST_P(TuningStrategyTest, testRemoveN3OptionRemoveAll) {
  ...
  auto search = autopas::TuningStrategyFactory::generateTuningStrategy(
      ...
      {autopas::DataLayoutOption::soa, autopas::DataLayoutOption::aos}, {autopas::Newton3Option::enabled}, 1, 1.2, 5, 10, false, 3,
      autopas::AcquisitionFunctionOption::expectedImprovement, autopas::ExtrapolationMethodOption::linePrediction);
