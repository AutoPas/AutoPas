...
TEST_F(BayesianSearchTest, testSearchSpaceEmpty) {
  autopas::BayesianSearch<Particle, FPCell> bayesianSearch(std::set<autopas::ContainerOption>({}));
...
TEST_F(BayesianSearchTest, testSearchSpaceOneOption) {
  autopas::BayesianSearch<Particle, FPCell> bayesianSearch({autopas::ContainerOption::directSum}, autopas::NumberSetFinite<double>({1.}),
...
TEST_F(BayesianSearchTest, testSearchSpaceMoreOptions) {
  autopas::BayesianSearch<Particle, FPCell> bayesianSearch(
...
TEST_F(BayesianSearchTest, testRemoveN3OptionRemoveSome) {
  autopas::BayesianSearch<Particle, FPCell> bayesianSearch({autopas::ContainerOption::linkedCells},
...
TEST_F(BayesianSearchTest, testMaxEvidence) {
  ...
  autopas::BayesianSearch<Particle, FPCell> bayesSearch(
      {autopas::ContainerOption::linkedCells}, autopas::NumberSetFinite<double>({1}),
...
TEST_F(BayesianSearchTest, testFindBest) {
  ...
  autopas::BayesianSearch<Particle, FPCell> bayesSearch({autopas::ContainerOption::linkedCells}, autopas::NumberSetFinite<double>({1, 2}),
