...
class AutoTunerTest : public AutoPasTestBase {
 public:
  ...
  const autopas::Configuration _confLc_c01{autopas::ContainerOption::linkedCells,
                                           _cellSizeFactor,
                                           ...
                                           5};
  const autopas::Configuration _confLc_c04{autopas::ContainerOption::linkedCells,
                                           _cellSizeFactor,
                                           autopas::TraversalOption::lc_c04,
                                           autopas::LoadEstimatorOption::none,
                                           autopas::DataLayoutOption::aos,
                                           autopas::Newton3Option::disabled,
                                           5};
  const autopas::Configuration _confLc_c08{autopas::ContainerOption::linkedCells,
                                           _cellSizeFactor,
