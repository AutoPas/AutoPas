...
//  autopas::LinkedCells<Molecule> linkedCells{{0., 0., 0.}, {10., 10., 10.}, 1., 0., 1};
...
//  ContainerIterator<Molecule, FMCell, true> iter{&cells, cells.size(), nullptr, IteratorBehavior::ownedOrHaloOrDummy,
