...
TEST_F(AutoTunerTest, testAllConfigurations) {
  ...
  const auto searchSpace = autopas::SearchSpaceGenerators::cartesianProduct(
      ...
      autopas::Newton3Option::getAllOptions(), &cellSizeFactors, autopas::OpenMPKindOption::getAllOptions(),
      &ompChunkSizes, autopas::InteractionTypeOption::pairwise);
  ...
  // ToDo OpenMP tuning branch before merge. Come back here and fix.
