...
TEST_F(ReinforcementLearningTest, invalidConfigurationConstructor) {
  ...
  EXPECT_THROW(autopas::ReinforcementLearning(-0.1, 0.8, 5, autopas::ReinforcementModelOption::SARSA),
               autopas::utils::ExceptionHandler::AutoPasException)
      << "The constructor must throw when encountering invalid input arguments.";
  EXPECT_THROW(autopas::ReinforcementLearning(1.1, 0.8, 2, autopas::ReinforcementModelOption::QLearning),
               autopas::utils::ExceptionHandler::AutoPasException)
      << "The constructor must throw when encountering invalid input arguments.";

  // Test invalid discount factors
  EXPECT_THROW(autopas::ReinforcementLearning(0.8, -0.1, 3, autopas::ReinforcementModelOption::SARSA),
               autopas::utils::ExceptionHandler::AutoPasException)
      << "The constructor must throw when encountering invalid input arguments.";
  EXPECT_THROW(autopas::ReinforcementLearning(0.8, 1.1, 5, autopas::ReinforcementModelOption::QLearning),
               autopas::utils::ExceptionHandler::AutoPasException)
      << "The constructor must throw when encountering invalid input arguments.";

  // Test invalid number of random explorations
  EXPECT_THROW(autopas::ReinforcementLearning(0.8, 0.8, 0, autopas::ReinforcementModelOption::SARSA),
               autopas::utils::ExceptionHandler::AutoPasException)
      << "The constructor must throw when encountering invalid input arguments.";

  // Test multiple valid configurations
  EXPECT_NO_THROW(autopas::ReinforcementLearning(0.8, 0.8, 5, autopas::ReinforcementModelOption::SARSA))
      << "The constructor must not fail when passing invalid arguments.";
  EXPECT_NO_THROW(autopas::ReinforcementLearning(0.5, 0.5, 2, autopas::ReinforcementModelOption::SARSA))
      << "The constructor must not fail when passing invalid arguments.";
  EXPECT_NO_THROW(autopas::ReinforcementLearning(0.2, 0.8, 6, autopas::ReinforcementModelOption::SARSA))
      << "The constructor must not fail when passing invalid arguments.";
  EXPECT_NO_THROW(autopas::ReinforcementLearning(0.5, 0.1, 1, autopas::ReinforcementModelOption::SARSA))
      << "The constructor must not fail when passing invalid arguments.";
  EXPECT_NO_THROW(autopas::ReinforcementLearning(0.8, 0.8, 5, autopas::ReinforcementModelOption::QLearning))
      << "The constructor must not fail when passing invalid arguments.";
  EXPECT_NO_THROW(autopas::ReinforcementLearning(0.5, 0.5, 2, autopas::ReinforcementModelOption::QLearning))
      << "The constructor must not fail when passing invalid arguments.";
  EXPECT_NO_THROW(autopas::ReinforcementLearning(0.2, 0.8, 6, autopas::ReinforcementModelOption::QLearning))
      << "The constructor must not fail when passing invalid arguments.";
  EXPECT_NO_THROW(autopas::ReinforcementLearning(0.5, 0.1, 1, autopas::ReinforcementModelOption::QLearning))
      << "The constructor must not fail when passing invalid arguments.";
}
...
TEST_F(ReinforcementLearningTest, firstSearchIsFullSearch) {
  ...
  autopas::ReinforcementLearning rl(0.8, 0.8, 5, autopas::ReinforcementModelOption::SARSA);
...
TEST_F(ReinforcementLearningTest, correctConfigExplorationPhase) {
  ...
  for (const auto reinforcementModel :
       {autopas::ReinforcementModelOption::SARSA, autopas::ReinforcementModelOption::QLearning}) {
    autopas::ReinforcementLearning rl(0.8, 0.8, searchSpace.size() - 1, reinforcementModel);
...
TEST_F(ReinforcementLearningTest, correctNumberOfRandomSamples) {
  ...
  for (const auto reinforcementModel :
       {autopas::ReinforcementModelOption::SARSA, autopas::ReinforcementModelOption::QLearning}) {
    autopas::ReinforcementLearning rl(0.8, 0.8, 3, reinforcementModel);
...
TEST_F(ReinforcementLearningTest, singleBestConfigAlwaysSampled) {
  ...
  autopas::ReinforcementLearning rl(0.8, 0.8, 3, autopas::ReinforcementModelOption::SARSA);
  ASSERT_GT(searchSpace.size(), 5);
