...
class EvidenceCollectionTest : public AutoPasTestBase {
 public:
  static constexpr autopas::Configuration _configurationLC_C01 = autopas::Configuration(
      ...
      autopas::DataLayoutOption::soa, autopas::Newton3Option::disabled, autopas::OpenMPKindOption::omp_dynamic, 1, autopas::InteractionTypeOption::pairwise);
  ...
  static constexpr autopas::Configuration _configurationLC_Sliced =
      autopas::Configuration(autopas::ContainerOption::linkedCells, 1., autopas::TraversalOption::lc_sliced,
                             ...
                             autopas::Newton3Option::disabled, autopas::OpenMPKindOption::omp_dynamic, 1, autopas::InteractionTypeOption::pairwise);
};
