...
void applyFunctor(MockFunctor<Particle> &functor, const double cellSizefactor) {
  ...
  autopas::VLCC18Traversal<FPCell, MFunctor, autopas::DataLayoutOption::aos, true, typename autopas::VerletListsCellsHelpers<Particle>::NeighborListsType, 0> traversal(
