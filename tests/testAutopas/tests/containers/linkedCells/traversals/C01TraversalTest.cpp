...
TEST_F(C01TraversalTest, testIsApplicable) {
  ...
  autopas::LCC01Traversal<FPCell, MPairwiseFunctor, false> c01T_N3off(dims, &functor, 1., {1., 1., 1.},
                                                                      autopas::DataLayoutOption::soa, false);
  EXPECT_EQ(c01T_N3off.isApplicable(), true);

  autopas::LCC01Traversal<FPCell, MPairwiseFunctor, false> c01T_N3on(dims, &functor, 1., {1., 1., 1.},
  ...
  autopas::LCC01Traversal<FPCell, MPairwiseFunctor, true> c01T_N3off_combineSoA_AoS(
      dims, &functor, 1., {1., 1., 1.}, autopas::DataLayoutOption::aos, false);
