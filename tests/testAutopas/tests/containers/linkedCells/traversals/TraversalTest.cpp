...
void testTraversal(autopas::TraversalOption traversalOption, autopas::LoadEstimatorOption loadEstimatorOption,
  ...
  autopas::LinkedCells<ParticleFP64> linkedCells(linkedCellsBoxMin, linkedCellsBoxMax, cutoff, 0.0, 1.0 / cutoff,
                                                 loadEstimatorOption);
...
TEST_P(TraversalTest, testTraversal_8x8x8_overlap2) {
  ...
  if (traversalOption == autopas::TraversalOption::lc_c04 or traversalOption == autopas::TraversalOption::lc_c04_HCP) {
