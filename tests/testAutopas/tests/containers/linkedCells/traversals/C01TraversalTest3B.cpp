...
TEST_F(C01TraversalTest3B, testIsApplicable) {
  ...
  autopas::LCC01Traversal<FPCell, MTriwiseFunctor> c01T_N3off(dims, &functor, 1., {1., 1., 1.},
                                                              autopas::DataLayoutOption::aos, false);
  EXPECT_EQ(c01T_N3off.isApplicable(), true);

  autopas::LCC01Traversal<FPCell, MTriwiseFunctor> c01T_N3on(dims, &functor, 1., {1., 1., 1.},
