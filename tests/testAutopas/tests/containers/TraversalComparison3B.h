 ...
 */
class TraversalComparison3B : public AutoPasTestBase, public ::testing::WithParamInterface<TestingTuple> {
 public:
 ...
 protected:
  ...
  static constexpr double _nu{0.1};
