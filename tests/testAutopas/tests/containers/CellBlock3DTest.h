...
class CellBlock3DTest : public AutoPasTestBase {
 public:
  CellBlock3DTest()
      : _cells_1x1x1(_vec1, std::array<double, 3>({0.0, 0.0, 0.0}), std::array<double, 3>({10.0, 10.0, 10.0}), 10.0),
        _cells_1x1x1_cs(_vec1_cs, std::array<double, 3>({0.0, 0.0, 0.0}), std::array<double, 3>({10.0, 10.0, 10.0}),
                        5.0, 2.0),
        _cells_2x2x2(_vec2, std::array<double, 3>({0.0, 0.0, 0.0}), std::array<double, 3>({10.0, 10.0, 10.0}), 5.0),
        _cells_2x2x2_cs(_vec2_cs, std::array<double, 3>({0.0, 0.0, 0.0}), std::array<double, 3>({10.0, 10.0, 10.0}),
                        10.0, 0.5),
 ...
 protected:
  std::vector<autopas::FullParticleCell<autopas::MoleculeLJ>> _vec1, _vec1_cs, _vec2, _vec2_cs, _vec3, _vec4, _vec19;
  autopas::CellBlock3D<autopas::FullParticleCell<autopas::MoleculeLJ>> _cells_1x1x1, _cells_1x1x1_cs, _cells_2x2x2,
      _cells_2x2x2_cs, _cells_3x3x3, _cells_11x4x4_nonZeroBoxMin, _cells_19x19x19;
};
