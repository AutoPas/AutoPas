/**
 * @file FullSortedParticleCellTest.cpp
 * @author C. Menges
 * @date 26.05.2019
 */

#include "FullSortedParticleCellTest.h"
#include "autopas/cells/FullParticleCell.h"

TEST_F(FullSortedParticleCellTest, testParticleAccess) {
  auto fpc = autopas::FullParticleCell<Particle>();
  Particle p1 = Particle();
  fpc.addParticle(p1);
  auto fspc = autopas::FullSortedParticleCell<Particle, autopas::FullParticleCell<Particle>>(fpc, {1., 0., 0.});
