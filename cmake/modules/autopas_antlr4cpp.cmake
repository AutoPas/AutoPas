...
if (AUTOPAS_ENABLE_RULES_BASED_TUNING)
    ...
    if (NOT UUID_FOUND)
        ...
        message(WARNING "1) Install UUID on your machine yourself.")
        message(WARNING "2) Disable rules-based tuning via the CMake option -DAUTOPAS_ENABLE_RULES_BASED_TUNING=OFF.")
        message(WARNING "3) (Untested!) Install automake 1.13")
