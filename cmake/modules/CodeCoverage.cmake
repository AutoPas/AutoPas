...
FUNCTION(SETUP_TARGET_FOR_COVERAGE_COBERTURA _targetname _testrunner _outputname _testcommandparam _customexcludepattern)
    ...
    ADD_CUSTOM_TARGET(${_targetname}
            ...
            # Running gcovr
            COMMAND ${GCOVR_PATH} -x -r ${CMAKE_SOURCE_DIR} -e '${CMAKE_SOURCE_DIR}/tests/' -e '${CMAKE_SOURCE_DIR}/build/' -e '${CMAKE_SOURCE_DIR}/libs/' -e ${COVERAGE_CUSTOMEXCLUDE} -o ${_outputname}.xml
            WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
