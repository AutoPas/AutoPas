    ...
    if (AUTOPAS_ENABLE_CUDA)
        target_compile_options(
            ...
            PUBLIC
                ...
                $<$<AND:$<STREQUAL:${VECTOR_INSTRUCTIONS},AVX2>,$<OR:$<CXX_COMPILER_ID:GNU>,$<CXX_COMPILER_ID:Clang>>>:$<$<COMPILE_LANGUAGE:CUDA>:-Xcompiler=>-mavx2
                $<$<COMPILE_LANGUAGE:CUDA>:-Xcompiler=>-mfma>
                $<$<AND:$<STREQUAL:${VECTOR_INSTRUCTIONS},AVX2>,$<CXX_COMPILER_ID:Intel>>:$<$<COMPILE_LANGUAGE:CUDA>:-Xcompiler=>-march=core-avx2
        ...
        target_compile_options(
            ...
            PUBLIC
                ...
                $<$<AND:$<STREQUAL:${VECTOR_INSTRUCTIONS},AVX2>,$<OR:$<CXX_COMPILER_ID:GNU>,$<CXX_COMPILER_ID:Clang>>>:-mavx2
                -mfma>
                $<$<AND:$<STREQUAL:${VECTOR_INSTRUCTIONS},AVX2>,$<CXX_COMPILER_ID:Intel>>:-march=core-avx2
                -fma>
