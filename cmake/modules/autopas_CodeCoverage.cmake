...
if (AUTOPAS_ENABLE_COVERAGE)
  ...
  if (NOT GCOV_EXECUTABLE OR NOT LCOV_EXECUTABLE OR NOT GENHTML_EXECUTABLE)
    ...
    message(STATUS "GENHTML found at: ${GENHTML_EXECUTABLE}")
  endif ()
  ...
  add_custom_target(
    ...
    COMMAND ${LCOV_EXECUTABLE} --ignore-errors mismatch --ignore-errors inconsistent --rc branch_coverage=1 --directory . --capture --exclude '*/tests/*' --exclude '/usr/*' --exclude ${CMAKE_BINARY_DIR} --output-file coverage.info
