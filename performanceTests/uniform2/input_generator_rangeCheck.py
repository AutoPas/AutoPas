...
NUM_REPEATS = 3
TOTAL_PARTICLE_COUNTS = [1_000, 50_000, 100_000, 300_000]
SIGMAMAX = 1.0
...
# generated_inputs_rangeCheck/totalParticles_<N>/sigmaRatio_<sigma1_over_sigma0>/countRatio_<n1_over_n0>/dataLayout_<AoS|SoA>/run_<run>
for total_particles in TOTAL_PARTICLE_COUNTS:
    particles_dir = OUTPUT_ROOT / f"totalParticles_{total_particles:06d}"
    ...
    for sigma_ratio in SIGMA_RATIOS:
        ...
        sigma_dir = particles_dir / f"sigmaRatio_{format_ratio(sigma_ratio)}"
