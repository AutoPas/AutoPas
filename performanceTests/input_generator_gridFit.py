...
OUTPUT_ROOT = SCRIPT_DIR / "generated_inputs_gridFit"
...
# generated_inputs_gridFit/totalParticles_<N>/sigmaRatio_<sigma1_over_sigma0>/countRatio_<n1_over_n0>/dataLayout_<AoS|SoA>/run_<run>
