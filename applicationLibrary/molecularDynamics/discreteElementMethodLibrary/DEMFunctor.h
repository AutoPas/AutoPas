...
class DEMFunctor
 ...
 public:
   ...
   * @param cutoff
   */
  explicit DEMFunctor(double cutoff) : DEMFunctor(cutoff, 150., 5, 5, 5e-5, 0.75, 0.25, 0.25, 30, 30, 20, 20, nullptr) {
  ...
  explicit DEMFunctor(double cutoff, ParticlePropertiesLibrary<double, size_t> &particlePropertiesLibrary)
      : DEMFunctor(cutoff, 150., 5, 5, 5e-5, 0.75, 0.25, 0.25, 30, 30, 20, 20, nullptr) {
