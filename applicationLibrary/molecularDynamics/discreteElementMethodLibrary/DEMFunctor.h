...
class DEMFunctor
 ...
 public:
   ...
   * @param cutoff
   */
  explicit DEMFunctor(double cutoff) : DEMFunctor(cutoff, 50., 5, 5, 1e-3, 0.1, 0.01, 0.01, 7.5, 5, 5, 5, nullptr) {
  ...
  explicit DEMFunctor(double cutoff, ParticlePropertiesLibrary<double, size_t> &particlePropertiesLibrary)
      : DEMFunctor(cutoff, 50., 5, 5, 1e-3, 0.1, 0.01, 0.01, 7.5, 5, 5, 5, nullptr) {
