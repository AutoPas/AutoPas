 ...
 */
template <class MoleculeType = mdLib::MultisiteMoleculeLJ>
class LJParentMultiSiteFunctorTest : public AutoPasTestBase {
 public:
  /**
   * Constructor
   */
  LJParentMultiSiteFunctorTest() = default;
   ...
   */
  void generateMolecules(std::vector<MoleculeType> *molecules, std::array<double, 3> offset = {0, 0, 0},
                         bool allOwned = true, const ParticlePropertiesLibrary<double, size_t>* ppl = nullptr);
  ...
  void testAoSForceCalculation(MoleculeType molA, MoleculeType molB,
   ...
   * @param cutoff
   */
  void testSuiteAoSForceCalculation(MoleculeType molA, MoleculeType molB,
                                    ParticlePropertiesLibrary<double, size_t> PPL, double cutoff);
  ...
  void singleSiteSanityCheck(MoleculeType molA, MoleculeType molB,
                             ParticlePropertiesLibrary<double, size_t> PPL, double cutoff);
   ...
   */
  template <bool newton3, bool calculateGlobals, bool applyShift>
  void testSoACellAgainstAoS(std::vector<MoleculeType> molecules,
                             ParticlePropertiesLibrary<double, size_t> PPL, double cutoff);
   ...
   */
  template <bool newton3, bool calculateGlobals, bool applyShift>
  void testSoACellPairAgainstAoS(std::vector<MoleculeType> moleculesA,
   ...
   */
  template <bool newton3, bool calculateGlobals, bool applyShift>
  void testSoAVerletAgainstAoS(std::vector<MoleculeType> molecules,
                               ParticlePropertiesLibrary<double, size_t> PPL, double cutoff);
};