/**
 * @file KryptonExtendedATMFunctorTestNoGlobals.cpp
 * @author D. Martin
 * @date 15.12.25
 */

#include "KryptonExtendedATMFunctorTestNoGlobals.h"

TYPED_TEST_SUITE_P(KryptonExtendedATMFunctorTestNoGlobals);

TYPED_TEST_P(KryptonExtendedATMFunctorTestNoGlobals, testAoSNoGlobalsKryptonExtendedATM) {
  ...
  Molecule p2({0.7, 0.8, 0.6}, {0., 0., 0.}, 1, 0);
  Molecule p3({-0.6, 0.8, 0.7}, {0., 0., 0.}, 2, 0);
...
TYPED_TEST_P(KryptonExtendedATMFunctorTestNoGlobals, testSoANoGlobalsKryptonExtendedATM) {
  using namespace autopas::utils::ArrayMath::literals;
  using FuncType = typename TypeParam::FuncType;
  using TestType = KryptonExtendedATMFunctorTestNoGlobals<FuncType>;
  constexpr bool newton3 = TypeParam::newton3;
...
REGISTER_TYPED_TEST_SUITE_P(KryptonExtendedATMFunctorTestNoGlobals, testAoSNoGlobalsKryptonExtendedATM,
                            testSoANoGlobalsKryptonExtendedATM);
...
using MyTypes = ::testing::Types<Newton3True<KryptonATMFunNoMixNoGlob>, Newton3False<KryptonATMFunNoMixNoGlob>>;

INSTANTIATE_TYPED_TEST_SUITE_P(GeneratedTyped, KryptonExtendedATMFunctorTestNoGlobals, MyTypes);