/**
 * @file ATMFunctorTestNoGlobalsHWY.cpp
 * @author muehlhaeusser, d.martin
 * @date 26.09.23
 */

#include "ATMFunctorTestNoGlobalsHWY.h"

TYPED_TEST_SUITE_P(ATMFunctorTestNoGlobalsHWY);

TYPED_TEST_P(ATMFunctorTestNoGlobalsHWY, testAoSNoGlobalsATMHWY) {
...
TYPED_TEST_P(ATMFunctorTestNoGlobalsHWY, testSoANoGlobalsATMHWY) {
  using namespace autopas::utils::ArrayMath::literals;
  using FuncType = typename TypeParam::FuncType;
  using TestType = ATMFunctorTestNoGlobalsHWY<FuncType>;
  constexpr bool mixing = FuncType::getMixing();
  constexpr bool newton3 = TypeParam::newton3;
...
REGISTER_TYPED_TEST_SUITE_P(ATMFunctorTestNoGlobalsHWY, testAoSNoGlobalsATMHWY, testSoANoGlobalsATMHWY);
...
using MyTypes = ::testing::Types<Newton3True<ATMFunHWYMixNoGlob>, Newton3False<ATMFunHWYMixNoGlob>,
                                 Newton3True<ATMFunHWYNoMixNoGlob>, Newton3False<ATMFunHWYNoMixNoGlob>>;

INSTANTIATE_TYPED_TEST_SUITE_P(GeneratedTyped, ATMFunctorTestNoGlobalsHWY, MyTypes);