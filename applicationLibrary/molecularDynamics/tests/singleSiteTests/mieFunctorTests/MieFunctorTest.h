...
/**
 * Test class for MieFunctor
 */
class MieFunctorTest : public AutoPasTestBase {
 public:
  /**
   * Constructor
   */
  MieFunctorTest() = default;
 ...
 */
void generateMolecules(std::vector<mdLib::MoleculeLJ> *molecules, std::array<double, 3> offset,bool allOwned);
/**
   * Tests the correctness of the AoS functor for a given n, m, PPL, and cutoff.
...
void testAoSForceCalculation(uint16_t n, uint16_t m, mdLib::MoleculeLJ molA, mdLib::MoleculeLJ molB,
...
void ljSanityCheck(mdLib::MoleculeLJ molA, mdLib::MoleculeLJ molB,
                           ParticlePropertiesLibrary<double, size_t> PPL, double cutoff);
