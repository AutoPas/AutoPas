...
class LJFunctorSVE
    : public autopas::Functor<
          Particle, LJFunctorSVE<Particle, applyShift, useMixing, useNewton3, calculateGlobals, relevantForTuning, countFLOPs>> {
 ...
 public:
  ...
  size_t getNumFLOPs() {
    autopas::utils::ExceptionHandler::exception("LJFunctorSVE::getNumFLOPs called but is not implemented");
    return 0;
  }
