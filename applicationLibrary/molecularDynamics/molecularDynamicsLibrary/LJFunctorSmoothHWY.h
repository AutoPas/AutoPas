...
// #define HWY_TARGET_INCLUDE "molecularDynamicsLibrary/LJFunctorSmoothHWY.h"
...
//const highway::Half<highway::ScalableTag<double>> tag_half_double;
...
//const highway::Half<highway::DFromV<VectorDouble>> tag_half_double;
...
class LJFunctorSmoothHWY
    : public autopas::Functor<Particle,
                              LJFunctorSmoothHWY<Particle, applyShift, useMixing, useNewton3, calculateGlobals, relevantForTuning>> {
  using SoAArraysType = typename Particle::SoAArraysType;

 public:
  LJFunctorSmoothHWY() = delete;

 private:
  explicit LJFunctorSmoothHWY(double cutoff,double innerCutoff, void*)
      : autopas::Functor<Particle,
                         LJFunctorSmoothHWY<Particle, applyShift, useMixing, useNewton3, calculateGlobals, relevantForTuning>>(cutoff),
 ...
 public:
  /**
         ...
         * @param cutoff
   */
  explicit LJFunctorSmoothHWY(double cutoff,double innerCutoff) : LJFunctorSmoothHWY(cutoff, innerCutoff, nullptr) {
   ...
   */
  explicit LJFunctorSmoothHWY(double cutoff,double innerCutoff, ParticlePropertiesLibrary<double, size_t> &particlePropertiesLibrary)
      : LJFunctorSmoothHWY(cutoff, innerCutoff, nullptr) {
