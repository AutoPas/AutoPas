...
class MieFunctorSVEFixed
    : public autopas::Functor<Particle, MieFunctorSVEFixed<Particle, applyShift, useMixing, useNewton3,
 ...
 private:
  ...
  explicit MieFunctorSVEFixed(double cutoff, void * /*dummy*/)
      ...
      : autopas::Functor<Particle, MieFunctorSVEFixed<Particle, applyShift, useMixing, useNewton3, calculateGlobals,
 ...
 private:
  ...
  inline void mie(const svuint64_t &index, const size_t *const typeID1ptr, const size_t *const typeID2ptr,
                  const svbool_t &pgC, const svfloat64_t &dr2, svfloat64_t &cepsilons, svfloat64_t &cnepsilons,
                  svfloat64_t &cmepsilons, svfloat64_t &shift6s, svfloat64_t &mie6, svfloat64_t &fac) {
  ...
  __attribute__((always_inline)) inline void SoAKernel(
    ...
    svfloat64_t fac_1;
    if (continue_1)
      mie<indexed>(index_1, typeID1ptr, typeID2ptr, pgC_1, dr2_1, cepsilons_1, cnepsilons_1, cmepsilons_1, shift6s_1,
                   mie6_1, fac_1);
    ...
    svfloat64_t fac_2;
    if (continue_2)
      mie<indexed>(index_2, typeID1ptr, typeID2ptr, pgC_2, dr2_2, cepsilons_2, cnepsilons_2, cmepsilons_2, shift6s_2,
                   mie6_2, fac_2);
    ...
    svfloat64_t fac_3;
    if (continue_3)
      mie<indexed>(index_3, typeID1ptr, typeID2ptr, pgC_3, dr2_3, cepsilons_3, cnepsilons_3, cmepsilons_3, shift6s_3,
                   mie6_3, fac_3);
    ...
    svfloat64_t fac_4;
    if (continue_4)
      mie<indexed>(index_4, typeID1ptr, typeID2ptr, pgC_4, dr2_4, cepsilons_4, cnepsilons_4, cmepsilons_4, shift6s_4,
                   mie6_4, fac_4);
 ...
 private:
  ...
  void SoAFunctorVerletImpl(autopas::SoAView<SoAArraysType> soa, const size_t indexFirst,
    ...
    for (; j < neighborList.size(); j += svlen(x1)) {
      ...
      svfloat64_t fac_1;
      if (continue_1)
        mie<true>(index_1, typeIDptr, typeIDptr, pgC_1, dr2_1, cepsilons_1, cnepsilons_1, cmepsilons_1, shift6s_1,
                  mie6_1, fac_1);
 ...
 public:
   ...
   * @note molAType and molBType make no difference for mieFunctor, but are kept to have a consistent interface for
  ...
  void setParticleProperties(double epsilon, double sigmaSquared) {
    ...
    c = c * pow(static_cast<double>(_nexpAoS) / static_cast<double>(_mexpAoS),
                static_cast<double>(_mexpAoS) / (_nexpAoS - _mexpAoS));
    ...
    if constexpr (applyShift) {
      _shift6 = ParticlePropertiesLibrary<double, size_t>::calcShiftMie(cepsilon, sigmaSquared, _cutoffSquaredAoS,
                                                                        _nexpAoS, _mexpAoS);
    } else {
      _shift6 = 0.0;
    }
    ...
    if constexpr (applyShift) {
      _shift6AoS = ParticlePropertiesLibrary<double, size_t>::calcShiftMie(cepsilon, sigmaSquared, _cutoffSquaredAoS,
                                                                           _nexpAoS, _mexpAoS);
    } else {
      _shift6AoS = 0.0;
    }
