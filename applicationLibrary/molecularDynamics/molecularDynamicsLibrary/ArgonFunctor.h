...
template <class Particle, autopas::FunctorN3Modes useNewton3 = autopas::FunctorN3Modes::Both,
        bool useLUT= false, bool useLUTGlobal=false,
         bool calculateGlobals = false>
class ArgonFunctor : public autopas::TriwiseFunctor<Particle, ArgonFunctor<Particle, useNewton3, useLUT, useLUTGlobal, calculateGlobals>> {
...
public:
 ...
 void AoSFunctor(Particle &i, Particle &j, Particle &k, bool newton3) {
   ...
   if constexpr (calculateGlobals) {
    ...
    [[nodiscard]] std::array<double, 3> getLUTValues(double distSquaredIJ, double distSquaredJK, double distSquaredKI) const{
