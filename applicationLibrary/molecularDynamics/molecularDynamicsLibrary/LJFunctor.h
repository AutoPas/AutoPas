...
template <class Particle_T, bool applyShift = false, bool useMixing = false, bool useLUT = false,
          bool useLUTGlobal = false, autopas::FunctorN3Modes useNewton3 = autopas::FunctorN3Modes::Both,
          bool calculateGlobals = false, bool countFLOPs = false, bool relevantForTuning = true>
class LJFunctor
    : public autopas::PairwiseFunctor<Particle_T,
                                      LJFunctor<Particle_T, applyShift, useMixing, useLUT, useLUTGlobal, useNewton3,
 ...
 private:
  ...
  explicit LJFunctor(double cutoff, void * /*dummy*/)
      : autopas::PairwiseFunctor<Particle_T, LJFunctor<Particle_T, applyShift, useMixing, useLUT, useLUTGlobal,
                                                       useNewton3, calculateGlobals, countFLOPs, relevantForTuning>>(
            cutoff),
