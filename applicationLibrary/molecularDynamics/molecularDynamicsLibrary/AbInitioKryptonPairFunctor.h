/**
 * @file AbInitioKryptonPairFunctor.h
 *
 * @date 27.04.2024
...
class AbInitioKryptonPairFunctor
 ...
 public:
   ...
   */
  AbInitioKryptonPairFunctor() = delete;
  ...
  std::string getName() final { return "AbInitioKryptonPairFunctor"; }
  ...
  void AoSFunctor(Particle &i, Particle &j, bool newton3) final {
    ...
    double fac = _kryptonKernel.calculatePairForce(dist);
 ...
 private:
  ...
  KryptonKernel _kryptonKernel = KryptonKernel{};
