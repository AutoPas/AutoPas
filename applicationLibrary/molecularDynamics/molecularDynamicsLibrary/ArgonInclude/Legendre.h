...
// */
//    template <size_t ID>
//    [[nodiscard]] nabla Q_deriv_wrt(const size_t A, const size_t B, const size_t C, double cosI,
//                                    double cosJ, double cosK) {
//        auto firstTerm = derivativeLegendre(cosI, A) * cosI.derive_wrt<ID>() * LegendrePol(cosJ, B) *
//                         LegendrePol(cosK, C);
//        auto secondTerm = LegendrePol(cosI, A) * derivativeLegendre(cosJ, B) * cosJ.derive_wrt<ID>() *
//                          LegendrePol(cosK, C);
//        auto thirdTerm = LegendrePol(cosI, A) * LegendrePol(cosJ, B) *
