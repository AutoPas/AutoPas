...
[[nodiscard]] nabla F_repulsive_abc(const std::array<double, 23> &A, const std::array<double, 23> &alpha,
                                    ...
                                    DisplacementHandle displacementKI, CosineHandle cosineI, CosineHandle cosineJ,
                                    CosineHandle cosineK) {
...
[[nodiscard]] nabla F_repulsive(const std::array<double, 23> &A, const std::array<double, 23> &alpha,
                                ...
                                CosineHandle cosineK) {
  const auto F =
      F_repulsive_abc<0, 0, 0, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<0, 0, 1, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<0, 1, 1, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<1, 1, 1, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<0, 0, 2, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<0, 1, 2, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<1, 1, 2, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<0, 2, 2, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<1, 2, 2, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<2, 2, 2, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<0, 0, 3, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<0, 1, 3, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<1, 1, 3, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<0, 2, 3, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<1, 2, 3, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<0, 3, 3, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<0, 0, 4, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<0, 1, 4, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<1, 1, 4, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<0, 2, 4, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<0, 0, 5, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
      F_repulsive_abc<0, 1, 5, ID>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                   cosineK) +
...
[[nodiscard]] inline double U_repulsive(const std::array<double, 23> &A, const std::array<double, 23> &alpha,
                                        ...
                                        CosineHandle cosineK) {
  const auto U =
      U_repulsive_abc<0, 0, 0>(A, alpha, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ, cosineK) +
