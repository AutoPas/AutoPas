...
[[nodiscard]] nabla F_dispersive(const std::array<double, 5> &Z, const std::array<double, 5> &beta,
                                 ...
                                 CosineHandle cosineK) {
  const auto F =
      F_dispersive_abc<1, 1, 1, ID>(Z, beta, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                    cosineK) +
      F_dispersive_abc<1, 1, 2, ID>(Z, beta, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                    cosineK) +
      F_dispersive_abc<1, 2, 1, ID>(Z, beta, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                    cosineK) +
      F_dispersive_abc<2, 1, 1, ID>(Z, beta, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                    cosineK) +
      F_dispersive_abc<1, 2, 2, ID>(Z, beta, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                    cosineK) +
      F_dispersive_abc<2, 1, 2, ID>(Z, beta, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                    cosineK) +
      F_dispersive_abc<2, 2, 1, ID>(Z, beta, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                    cosineK) +
      F_dispersive_abc<2, 2, 2, ID>(Z, beta, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                    cosineK) +
      F_dispersive_abc<1, 1, 3, ID>(Z, beta, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                    cosineK) +
      F_dispersive_abc<1, 3, 1, ID>(Z, beta, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ,
                                    cosineK) +
...
[[nodiscard]] inline double U_dispersive(const std::array<double, 5> &Z, const std::array<double, 5> &beta,
                                         ...
                                         CosineHandle cosineK) {
  const auto U =
      U_dispersive_abc<1, 1, 1>(Z, beta, displacementIJ, displacementJK, displacementKI, cosineI, cosineJ, cosineK) +
