...
namespace mdLib {
    ...
    public:
        ...
        LUT3B(int resolution, double cutoffSquared, bool global ) : ParentLUT(resolution, cutoffSquared) {
...
//       std::cout << "RETRIEVE VALUE ";
        ...
        std::array<double, 3>
        getWeightedAverage(size_t index1, size_t index2, size_t index3, size_t actual_dist0, size_t actual_dist1,
                           size_t actual_dist2) const {
...
//fill_plain_krypton(functor, cutoffSquared);
            }
            if (withGlobals) {
...
//alternative global LUT
        ...
        std::array<double, 2>
        calculateGlobalFac(double distSquaredIJ, double distSquaredJK, double distSquaredKI) const {
...
//      const double factor = 3.0 * nu / allDistsTo5;
        ...
        std::array<double, 2>
        calculateFullGlobal(double distSquaredIJ, double distSquaredJK, double distSquaredKI) const {
        ...
        std::array<double, 2>
        calculatePotEnergyTest(double distSquaredIJ, double distSquaredJK, double distSquaredKI) const {
...
//    [[nodiscard]] std::pair<const std::array<double, 3>, std::pair<std::array<u_int8_t, 3>, std::array<double,2>> retrieveValues_global(const Functor &functor, double dist1, double dist2, double dist3) const {
        [[nodiscard]] std::pair<const std::array<double, 5>, std::array<u_int8_t, 3>>
...
//        template<class Functor>
        ...
        void setLutTimer(const std::vector<autopas::utils::Timer> &lutTimer) {

          this->lutTimer =lutTimer;
        }
        ...
        void setConstantsAKrypton(const std::array<double, 6> &constantsAKrypton) {
          _constantsA_krypton = constantsAKrypton;
        }
...
//        const double _alpha = 1.378382;  // A^-1
        ...
        // Units: {K, K*A^-2, K*A^-4, K*A^-6, K*A^-8, K*A^-10}
         std::array<double, 6> _constantsA_krypton = {-0.3081304e8, -0.3519442e8, 0.4928052e7, -0.2182411e6, 0.343088e4,
                                                           0.0};
       ...
       public:
        [[nodiscard]] std::array<double, 3> getLUTValuesAT(double dist1Squared, double dist2Squared, double dist3Squared) const {
            // Calculate prefactor
        ...
        [[nodiscard]] std::array<double, 3> getLUTValuesKrypton(double dist1Squared,  double dist2Squared ,double dist3Squared ) const {
